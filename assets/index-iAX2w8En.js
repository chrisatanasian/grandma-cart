...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Fs(e,t,n){return new to({name:`SphericalGaussianBlur`,defines:{SAMPLES:bs,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},sigma:{value:0},mipInt:{value:0}},vertexShader:Rs(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Is(){return new to({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Rs(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ls(){return new to({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Rs(),fragmentShader:`
	...
	`}var zs=class extends Kt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new pi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
}`,mu=class{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){let n=new _i(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=n}}getMesh(e){if(this.texture!==null&&this.mesh===null){let t=e.cameras[0].viewport,n=new to({vertexShader:fu,fragmentShader:pu,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new Xr(new Va(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}},hu=class extends $e{constructor(e,t){super();let n=this,r=null,i=1,a=null,o=`local-floor`,s=1,c=null,u=null,d=null,f=null,p=null,h=null,g=typeof XRWebGLBinding<`u`,_=new mu,v={},b=t.getContextAttributes(),x=null,S=null,C=[],D=[],O=new W,k=null,A=null,j=new zo;j.viewport=new Wt;let M=new zo;M.viewport=new Wt;let ee=[j,M],N=new Ko,P=null,F=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(e){let t=C[e];return t===void 0&&(t=new Tn,C[e]=t),t.getTargetRaySpace()},this.getControllerGrip=function(e){let t=C[e];return t===void 0&&(t=new Tn,C[e]=t),t.getGripSpace()},this.getHand=function(e){let t=C[e];return t===void 0&&(t=new Tn,C[e]=t),t.getHandSpace()};function te(e){let t=D.indexOf(e.inputSource);if(t===-1)return;let n=C[t];n!==void 0&&(n.update(e.inputSource,e.frame,c||a),n.dispatchEvent({type:e.type,data:e.inputSource}))}function ne(){r.removeEventListener(`select`,te),r.removeEventListener(`selectstart`,te),r.removeEventListener(`selectend`,te),r.removeEventListener(`squeeze`,te),r.removeEventListener(`squeezestart`,te),r.removeEventListener(`squeezeend`,te),r.removeEventListener(`end`,ne),r.removeEventListener(`inputsourceschange`,re);for(let e=0;e<C.length;e++){let t=D[e];t!==null&&(D[e]=null,C[e].disconnect(t))}P=null,F=null,_.reset();for(let e in v)delete v[e];if(e.setRenderTarget(x),p=null,f=null,d=null,r=null,S=null,ue.stop(),n.isPresenting=!1,e.setPixelRatio(k),e.setSize(O.width,O.height,!1),A!==null){let e=A.camera;e.fov=A.fov,e.zoom=A.zoom,e.updateProjectionMatrix(),A=null}n.dispatchEvent({type:`sessionend`})}this.setFramebufferScaleFactor=function(e){i=e,n.isPresenting===!0&&V(`WebXRManager: Cannot change framebuffer scale while presenting.`)},this.setReferenceSpaceType=function(e){o=e,n.isPresenting===!0&&V(`WebXRManager: Cannot change reference space type while presenting.`)},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(e){c=e},this.getBaseLayer=function(){return f===null?p:f},this.getBinding=function(){return d===null&&g&&(d=new XRWebGLBinding(r,t)),d},this.getFrame=function(){return h},this.getSession=function(){return r},this.setSession=async function(u){if(r=u,r!==null){if(x=e.getRenderTarget(),r.addEventListener(`select`,te),r.addEventListener(`selectstart`,te),r.addEventListener(`selectend`,te),r.addEventListener(`squeeze`,te),r.addEventListener(`squeezestart`,te),r.addEventListener(`squeezeend`,te),r.addEventListener(`end`,ne),r.addEventListener(`inputsourceschange`,re),b.xrCompatible!==!0&&await t.makeXRCompatible(),k=e.getPixelRatio(),e.getSize(O),g&&`createProjectionLayer`in XRWebGLBinding.prototype){let n=null,a=null,o=null;b.depth&&(o=b.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,n=b.stencil?E:T,a=b.stencil?y:m);let s={colorFormat:t.RGBA8,depthFormat:o,scaleFactor:i};d=this.getBinding(),f=d.createProjectionLayer(s),r.updateRenderState({layers:[f]}),e.setPixelRatio(1),e.setSize(f.textureWidth,f.textureHeight,!1),S=new Kt(f.textureWidth,f.textureHeight,{format:w,type:l,depthTexture:new hi(f.textureWidth,f.textureHeight,a,void 0,void 0,void 0,void 0,void 0,void 0,n),stencilBuffer:b.stencil,colorSpace:e.outputColorSpace,samples:b.antialias?4:0,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1,storeMultisampledDepthBuffer:f.ignoreDepthValues===!1,storeMultisampledStencilBuffer:f.ignoreDepthValues===!1})}else{let n={antialias:b.antialias,alpha:!0,depth:b.depth,stencil:b.stencil,framebufferScaleFactor:i};p=new XRWebGLLayer(r,t,n),r.updateRenderState({baseLayer:p}),e.setPixelRatio(1),e.setSize(p.framebufferWidth,p.framebufferHeight,!1),S=new Kt(p.framebufferWidth,p.framebufferHeight,{format:w,type:l,colorSpace:e.outputColorSpace,stencilBuffer:b.stencil,resolveDepthBuffer:p.ignoreDepthValues===!1,resolveStencilBuffer:p.ignoreDepthValues===!1,storeMultisampledDepthBuffer:p.ignoreDepthValues===!1,storeMultisampledStencilBuffer:p.ignoreDepthValues===!1})}S.isXRRenderTarget=!0,this.setFoveation(s),c=null,a=await r.requestReferenceSpace(o),ue.setContext(r),ue.start(),n.isPresenting=!0,n.dispatchEvent({type:`sessionstart`})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return _.getDepthTexture()};function re(e){for(let t=0;t<e.removed.length;t++){let n=e.removed[t],r=D.indexOf(n);r>=0&&(D[r]=null,C[r].disconnect(n))}for(let t=0;t<e.added.length;t++){let n=e.added[t],r=D.indexOf(n);if(r===-1){for(let e=0;e<C.length;e++)if(e>=D.length){D.push(n),r=e;break}else if(D[e]===null){D[e]=n,r=e;break}if(r===-1)break}let i=C[r];i&&i.connect(n)}}let ie=new G,ae=new G;function oe(e,t,n){ie.setFromMatrixPosition(t.matrixWorld),ae.setFromMatrixPosition(n.matrixWorld);let r=ie.distanceTo(ae),i=t.projectionMatrix.elements,a=n.projectionMatrix.elements,o=i[14]/(i[10]-1),s=i[14]/(i[10]+1),c=(i[9]+1)/i[5],l=(i[9]-1)/i[5],u=(i[8]-1)/i[0],d=(a[8]+1)/a[0],f=o*u,p=o*d,m=r/(-u+d),h=m*-u;if(t.matrixWorld.decompose(e.position,e.quaternion,e.scale),e.translateX(h),e.translateZ(m),e.matrixWorld.compose(e.position,e.quaternion,e.scale),e.matrixWorldInverse.copy(e.matrixWorld).invert(),i[10]===-1)e.projectionMatrix.copy(t.projectionMatrix),e.projectionMatrixInverse.copy(t.projectionMatrixInverse);else{let t=o+m,n=s+m,i=f-h,a=p+(r-h),u=c*s/n*t,d=l*s/n*t;e.projectionMatrix.makePerspective(i,a,u,d,t,n),e.projectionMatrixInverse.copy(e.projectionMatrix).invert()}}function se(e,t){t===null?e.matrixWorld.copy(e.matrix):e.matrixWorld.multiplyMatrices(t.matrixWorld,e.matrix),e.matrixWorldInverse.copy(e.matrixWorld).invert()}this.updateCamera=function(e){if(r===null)return;let t=e.near,n=e.far;_.texture!==null&&(_.depthNear>0&&(t=_.depthNear),_.depthFar>0&&(n=_.depthFar)),N.near=M.near=j.near=t,N.far=M.far=j.far=n,(P!==N.near||F!==N.far)&&(r.updateRenderState({depthNear:N.near,depthFar:N.far}),P=N.near,F=N.far),N.layers.mask=e.layers.mask|6,j.layers.mask=N.layers.mask&-5,M.layers.mask=N.layers.mask&-3;let i=e.parent,a=N.cameras;se(N,i);for(let e=0;e<a.length;e++)se(a[e],i);a.length===2?oe(N,j,M):N.projectionMatrix.copy(j.projectionMatrix),A===null&&e.isPerspectiveCamera&&(A={camera:e,fov:e.fov,zoom:e.zoom}),I(e,N,i)};function I(e,t,n){n===null?e.matrix.copy(t.matrixWorld):(e.matrix.copy(n.matrixWorld),e.matrix.invert(),e.matrix.multiply(t.matrixWorld)),e.matrix.decompose(e.position,e.quaternion,e.scale),e.updateMatrixWorld(!0),e.projectionMatrix.copy(t.projectionMatrix),e.projectionMatrixInverse.copy(t.projectionMatrixInverse),e.isPerspectiveCamera&&(e.fov=rt*2*Math.atan(1/e.projectionMatrix.elements[5]),e.zoom=1)}this.getCamera=function(){return N},this.getFoveation=function(){if(f!==null||p!==null)return s},this.setFoveation=function(e){s=e,f!==null&&(f.fixedFoveation=e),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=e)},this.hasDepthSensing=function(){return _.texture!==null},this.getDepthSensingMesh=function(){return _.getMesh(N)},this.getCameraTexture=function(e){return v[e]};let ce=null;function le(t,i){if(u=i.getViewerPose(c||a),h=i,u!==null){let t=u.views;p!==null&&(e.setRenderTargetFramebuffer(S,p.framebuffer),e.setRenderTarget(S));let i=!1;t.length!==N.cameras.length&&(N.cameras.length=0,i=!0);for(let n=0;n<t.length;n++){let r=t[n],a=null;if(p!==null)a=p.getViewport(r);else{let t=d.getViewSubImage(f,r);a=t.viewport,n===0&&(e.setRenderTargetTextures(S,t.colorTexture,t.depthStencilTexture),e.setRenderTarget(S))}let o=ee[n];o===void 0&&(o=new zo,o.layers.enable(n),o.viewport=new Wt,ee[n]=o),o.matrix.fromArray(r.transform.matrix),o.matrix.decompose(o.position,o.quaternion,o.scale),o.projectionMatrix.fromArray(r.projectionMatrix),o.projectionMatrixInverse.copy(o.projectionMatrix).invert(),o.viewport.set(a.x,a.y,a.width,a.height),n===0&&(N.matrix.copy(o.matrix),N.matrix.decompose(N.position,N.quaternion,N.scale)),i===!0&&N.cameras.push(o)}let a=r.enabledFeatures;if(a&&a.includes(`depth-sensing`)&&r.depthUsage==`gpu-optimized`&&g){d=n.getBinding();let e=d.getDepthInformation(t[0]);e&&e.isValid&&e.texture&&_.init(e,r.renderState)}if(a&&a.includes(`camera-access`)&&g){e.state.unbindTexture(),d=n.getBinding();for(let e=0;e<t.length;e++){let n=t[e].camera;if(n){let e=v[n];e||(e=new _i,v[n]=e);let t=d.getCameraImage(n);e.sourceTexture=t}}}}for(let e=0;e<C.length;e++){let t=D[e],n=C[e];t!==null&&n!==void 0&&n.update(t,i,c||a)}ce&&ce(t,i),i.detectedPlanes&&n.dispatchEvent({type:`planesdetected`,data:i}),h=null}let ue=new ss;ue.setAnimationLoop(le),this.setAnimationLoop=function(e){ce=e},this.dispose=function(){}}},gu=new Yt,_u=new K;_u.set(-1,0,0,0,1,0,0,0,1);function vu(e,t){function n(e,t){e.matrixAutoUpdate===!0&&e.updateMatrix(),t.value.copy(e.matrix)}function r(t,n){n.color.getRGB(t.fogColor.value,Za(e)),n.isFog?(t.fogNear.value=n.near,t.fogFar.value=n.far):n.isFogExp2&&(t.fogDensity.value=n.density)}function i(e,t,n,r,i){t.isNodeMaterial?t.uniformsNeedUpdate=!1:t.isMeshBasicMaterial?a(e,t):t.isMeshLambertMaterial?(a(e,t),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)):t.isMeshToonMaterial?(a(e,t),d(e,t)):t.isMeshPhongMaterial?(a(e,t),u(e,t),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)):t.isMeshStandardMaterial?(a(e,t),f(e,t),t.isMeshPhysicalMaterial&&p(e,t,i)):t.isMeshMatcapMaterial?(a(e,t),m(e,t)):t.isMeshDepthMaterial?a(e,t):t.isMeshDistanceMaterial?(a(e,t),h(e,t)):t.isMeshNormalMaterial?a(e,t):t.isLineBasicMaterial?(o(e,t),t.isLineDashedMaterial&&s(e,t)):t.isPointsMaterial?c(e,t,n,r):t.isSpriteMaterial?l(e,t):t.isShadowMaterial?(e.color.value.copy(t.color),e.opacity.value=t.opacity):t.isShaderMaterial&&(t.uniformsNeedUpdate=!1)}function a(e,r){e.opacity.value=r.opacity,r.color&&e.diffuse.value.copy(r.color),r.emissive&&e.emissive.value.copy(r.emissive).multiplyScalar(r.emissiveIntensity),r.map&&(e.map.value=r.map,n(r.map,e.mapTransform)),r.alphaMap&&(e.alphaMap.value=r.alphaMap,n(r.alphaMap,e.alphaMapTransform)),r.bumpMap&&(e.bumpMap.value=r.bumpMap,n(r.bumpMap,e.bumpMapTransform),e.bumpScale.value=r.bumpScale,r.side===1&&(e.bumpScale.value*=-1)),r.normalMap&&(e.normalMap.value=r.normalMap,n(r.normalMap,e.normalMapTransform),e.normalScale.value.copy(r.normalScale),r.side===1&&e.normalScale.value.negate()),r.displacementMap&&(e.displacementMap.value=r.displacementMap,n(r.displacementMap,e.displacementMapTransform),e.displacementScale.value=r.displacementScale,e.displacementBias.value=r.displacementBias),r.emissiveMap&&(e.emissiveMap.value=r.emissiveMap,n(r.emissiveMap,e.emissiveMapTransform)),r.specularMap&&(e.specularMap.value=r.specularMap,n(r.specularMap,e.specularMapTransform)),r.alphaTest>0&&(e.alphaTest.value=r.alphaTest);let i=t.get(r),a=i.envMap,o=i.envMapRotation;a&&(e.envMap.value=a,e.envMapRotation.value.setFromMatrix4(gu.makeRotationFromEuler(o)).transpose(),a.isCubeTexture&&a.isRenderTargetTexture===!1&&e.envMapRotation.value.premultiply(_u),e.reflectivity.value=r.reflectivity,e.ior.value=r.ior,e.refractionRatio.value=r.refractionRatio),r.lightMap&&(e.lightMap.value=r.lightMap,e.lightMapIntensity.value=r.lightMapIntensity,n(r.lightMap,e.lightMapTransform)),r.aoMap&&(e.aoMap.value=r.aoMap,e.aoMapIntensity.value=r.aoMapIntensity,n(r.aoMap,e.aoMapTransform))}function o(e,t){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,t.map&&(e.map.value=t.map,n(t.map,e.mapTransform))}function s(e,t){e.dashSize.value=t.dashSize,e.totalSize.value=t.dashSize+t.gapSize,e.scale.value=t.scale}function c(e,t,r,i){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,e.size.value=t.size*r,e.scale.value=i*.5,t.map&&(e.map.value=t.map,n(t.map,e.uvTransform)),t.alphaMap&&(e.alphaMap.value=t.alphaMap,n(t.alphaMap,e.alphaMapTransform)),t.alphaTest>0&&(e.alphaTest.value=t.alphaTest)}function l(e,t){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,e.rotation.value=t.rotation,t.map&&(e.map.value=t.map,n(t.map,e.mapTransform)),t.alphaMap&&(e.alphaMap.value=t.alphaMap,n(t.alphaMap,e.alphaMapTransform)),t.alphaTest>0&&(e.alphaTest.value=t.alphaTest)}function u(e,t){e.specular.value.copy(t.specular),e.shininess.value=Math.max(t.shininess,1e-4)}function d(e,t){t.gradientMap&&(e.gradientMap.value=t.gradientMap)}function f(e,t){e.metalness.value=t.metalness,t.metalnessMap&&(e.metalnessMap.value=t.metalnessMap,n(t.metalnessMap,e.metalnessMapTransform)),e.roughness.value=t.roughness,t.roughnessMap&&(e.roughnessMap.value=t.roughnessMap,n(t.roughnessMap,e.roughnessMapTransform)),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)}function p(e,t,r){e.ior.value=t.ior,t.sheen>0&&(e.sheenColor.value.copy(t.sheenColor).multiplyScalar(t.sheen),e.sheenRoughness.value=t.sheenRoughness,t.sheenColorMap&&(e.sheenColorMap.value=t.sheenColorMap,n(t.sheenColorMap,e.sheenColorMapTransform)),t.sheenRoughnessMap&&(e.sheenRoughnessMap.value=t.sheenRoughnessMap,n(t.sheenRoughnessMap,e.sheenRoughnessMapTransform))),t.clearcoat>0&&(e.clearcoat.value=t.clearcoat,e.clearcoatRoughness.value=t.clearcoatRoughness,t.clearcoatMap&&(e.clearcoatMap.value=t.clearcoatMap,n(t.clearcoatMap,e.clearcoatMapTransform)),t.clearcoatRoughnessMap&&(e.clearcoatRoughnessMap.value=t.clearcoatRoughnessMap,n(t.clearcoatRoughnessMap,e.clearcoatRoughnessMapTransform)),t.clearcoatNormalMap&&(e.clearcoatNormalMap.value=t.clearcoatNormalMap,n(t.clearcoatNormalMap,e.clearcoatNormalMapTransform),e.clearcoatNormalScale.value.copy(t.clearcoatNormalScale),t.side===1&&e.clearcoatNormalScale.value.negate())),t.dispersion>0&&(e.dispersion.value=t.dispersion),t.retroreflectivity>0&&(e.retroreflectivity.value=t.retroreflectivity),t.iridescence>0&&(e.iridescence.value=t.iridescence,e.iridescenceIOR.value=t.iridescenceIOR,e.iridescenceThicknessMinimum.value=t.iridescenceThicknessRange[0],e.iridescenceThicknessMaximum.value=t.iridescenceThicknessRange[1],t.iridescenceMap&&(e.iridescenceMap.value=t.iridescenceMap,n(t.iridescenceMap,e.iridescenceMapTransform)),t.iridescenceThicknessMap&&(e.iridescenceThicknessMap.value=t.iridescenceThicknessMap,n(t.iridescenceThicknessMap,e.iridescenceThicknessMapTransform))),t.transmission>0&&(e.transmission.value=t.transmission,e.transmissionSamplerMap.value=r.texture,e.transmissionSamplerSize.value.set(r.width,r.height),t.transmissionMap&&(e.transmissionMap.value=t.transmissionMap,n(t.transmissionMap,e.transmissionMapTransform)),e.thickness.value=t.thickness,t.thicknessMap&&(e.thicknessMap.value=t.thicknessMap,n(t.thicknessMap,e.thicknessMapTransform)),e.attenuationDistance.value=t.attenuationDistance,e.attenuationColor.value.copy(t.attenuationColor)),t.anisotropy>0&&(e.anisotropyVector.value.set(t.anisotropy*Math.cos(t.anisotropyRotation),t.anisotropy*Math.sin(t.anisotropyRotation)),t.anisotropyMap&&(e.anisotropyMap.value=t.anisotropyMap,n(t.anisotropyMap,e.anisotropyMapTransform))),e.specularIntensity.value=t.specularIntensity,e.specularColor.value.copy(t.specularColor),t.specularColorMap&&(e.specularColorMap.value=t.specularColorMap,n(t.specularColorMap,e.specularColorMapTransform)),t.specularIntensityMap&&(e.specularIntensityMap.value=t.specularIntensityMap,n(t.specularIntensityMap,e.specularIntensityMapTransform))}function m(e,t){t.matcap&&(e.matcap.value=t.matcap)}function h(e,n){let r=t.get(n).light;e.referencePosition.value.setFromMatrixPosition(r.matrixWorld),e.nearDistance.value=r.shadow.camera.near,e.farDistance.value=r.shadow.camera.far}return{refreshFogUniforms:r,refreshMaterialUniforms:i}}function yu(e,t,n,r){let i={},a={},o=[],s=e.getParameter(e.MAX_UNIFORM_BUFFER_BINDINGS);function c(e,t){let n=t.program;r.uniformBlockBinding(e,n)}function l(e,n){let o=i[e.id];o===void 0&&(g(e),o=u(e),i[e.id]=o,e.addEventListener(`dispose`,v));let s=n.program;r.updateUBOMapping(e,s);let c=t.render.frame;a[e.id]!==c&&(f(e),a[e.id]=c)}function u(t){let n=d();t.__bindingPointIndex=n;let r=e.createBuffer(),i=t.__size,a=t.usage;return e.bindBuffer(e.UNIFORM_BUFFER,r),e.bufferData(e.UNIFORM_BUFFER,i,a),e.bindBuffer(e.UNIFORM_BUFFER,null),e.bindBufferBase(e.UNIFORM_BUFFER,n,r),r}function d(){for(let e=0;e<s;e++)if(o.indexOf(e)===-1)return o.push(e),e;return H(`WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached.`),0}function f(t){let n=i[t.id],r=t.uniforms,a=t.__cache;e.bindBuffer(e.UNIFORM_BUFFER,n);for(let e=0,t=r.length;e<t;e++){let t=r[e];if(Array.isArray(t))for(let n=0,r=t.length;n<r;n++)p(t[n],e,n,a);else p(t,e,0,a)}e.bindBuffer(e.UNIFORM_BUFFER,null)}function p(t,n,r,i){if(h(t,n,r,i)===!0){let n=t.__offset,r=t.value;if(Array.isArray(r)){let e=0;for(let n=0;n<r.length;n++){let i=r[n],a=_(i);m(i,t.__data,e),typeof i!=`number`&&typeof i!=`boolean`&&!i.isMatrix3&&!ArrayBuffer.isView(i)&&(e+=a.storage/Float32Array.BYTES_PER_ELEMENT)}}else m(r,t.__data,0);e.bufferSubData(e.UNIFORM_BUFFER,n,t.__data)}}function m(e,t,n){typeof e==`number`||typeof e==`boolean`?t[0]=e:e.isMatrix3?(t[0]=e.elements[0],t[1]=e.elements[1],t[2]=e.elements[2],t[3]=0,t[4]=e.elements[3],t[5]=e.elements[4],t[6]=e.elements[5],t[7]=0,t[8]=e.elements[6],t[9]=e.elements[7],t[10]=e.elements[8],t[11]=0):ArrayBuffer.isView(e)?t.set(new e.constructor(e.buffer,e.byteOffset,t.length)):e.toArray(t,n)}function h(e,t,n,r){let i=e.value,a=t+`_`+n;if(r[a]===void 0)return r[a]=typeof i==`number`||typeof i==`boolean`?i:ArrayBuffer.isView(i)?i.slice():i.clone(),!0;{let e=r[a];if(typeof i==`number`||typeof i==`boolean`){if(e!==i)return r[a]=i,!0}else if(ArrayBuffer.isView(i))return!0;else if(e.equals(i)===!1)return e.copy(i),!0}return!1}function g(e){let t=e.uniforms,n=0;for(let e=0,r=t.length;e<r;e++){let r=Array.isArray(t[e])?t[e]:[t[e]];for(let e=0,t=r.length;e<t;e++){let t=r[e],i=Array.isArray(t.value)?t.value:[t.value];for(let e=0,r=i.length;e<r;e++){let r=i[e],a=_(r),o=n%16,s=o%a.boundary,c=o+s;n+=s,c!==0&&16-c<a.storage&&(n+=16-c),t.__data=new Float32Array(a.storage/Float32Array.BYTES_PER_ELEMENT),t.__offset=n,n+=a.storage}}}let r=n%16;return r>0&&(n+=16-r),e.__size=n,e.__cache={},this}function _(e){let t={boundary:0,storage:0};return typeof e==`number`||typeof e==`boolean`?(t.boundary=4,t.storage=4):e.isVector2?(t.boundary=8,t.storage=8):e.isVector3||e.isColor?(t.boundary=16,t.storage=12):e.isVector4?(t.boundary=16,t.storage=16):e.isMatrix3?(t.boundary=48,t.storage=48):e.isMatrix4?(t.boundary=64,t.storage=64):e.isTexture?V(`WebGLRenderer: Texture samplers can not be part of an uniforms group.`):ArrayBuffer.isView(e)?(t.boundary=16,t.storage=e.byteLength):V(`WebGLRenderer: Unsupported uniform value type.`,e),t}function v(t){let n=t.target;n.removeEventListener(`dispose`,v);let r=o.indexOf(n.__bindingPointIndex);o.splice(r,1),e.deleteBuffer(i[n.id]),delete i[n.id],delete a[n.id]}function y(){for(let t in i)e.deleteBuffer(i[t]);o=[],i={},a={}}return{bind:c,update:l,dispose:y}}var bu=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]),xu=null;function Su(){return xu===null&&(xu=new $r(bu,16,16,k,g),xu.name=`DFG_LUT`,xu.minFilter=o,xu.magFilter=o,xu.wrapS=t,xu.wrapT=t,xu.generateMipmaps=!1,xu.needsUpdate=!0),xu}var Cu=class{constructor(e={}){let{canvas:t=Ke(),context:n=null,depth:r=!0,stencil:i=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:s=!0,preserveDrawingBuffer:u=!1,powerPreference:d=`default`,failIfMajorPerformanceCaveat:p=!1,reversedDepthBuffer:h=!1,outputBufferType:b=l}=e;this.isWebGLRenderer=!0;let x;if(n!==null){if(typeof WebGLRenderingContext<`u`&&n instanceof WebGLRenderingContext)throw Error(`THREE.WebGLRenderer: WebGL 1 is not supported since r163.`);x=n.getContextAttributes().alpha}else x=a;let S=b,C=new Set([j,A,O]),w=new Set([l,m,f,y,_,v]),T=new Uint32Array(4),E=new Int32Array(4),D=new G,k=null,M=null,ee=[],N=[],P=null;this.domElement=t,this.debug={checkShaderErrors:!0,diagnostics:{keywords:!1},onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=0,this.toneMappingExposure=1,this.transmissionResolutionScale=1;let F=this,te=!1,ne=null,re=null,ie=null,ae=null;this._outputColorSpace=Ie;let oe=0,se=0,I=null,ce=-1,le=null,ue=new Wt,de=new Wt,fe=null,pe=new J(0),me=0,he=t.width,ge=t.height,_e=1,ve=null,ye=null,be=new Wt(0,0,he,ge),xe=new Wt(0,0,he,ge),Se=!1,Ce=new fi,we=!1,Te=!1,Ee=new Yt,De=new G,Oe=new Wt,ke={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0},Ae=!1;function je(){return I===null?_e:1}let L=n;function Me(e,n){return t.getContext(e,n)}let Ne,Pe,R,Fe,z,B,Le,Re,ze,Be,Ve,Ue,We,Ge,qe,Ye,Xe,Qe,$e,et,tt,nt,rt;try{let e={alpha:!0,depth:r,stencil:i,antialias:o,premultipliedAlpha:s,preserveDrawingBuffer:u,powerPreference:d,failIfMajorPerformanceCaveat:p};if(`setAttribute`in t&&t.setAttribute(`data-engine`,`three.js r186`),t.addEventListener(`webglcontextlost`,at,!1),t.addEventListener(`webglcontextrestored`,ot,!1),t.addEventListener(`webglcontextcreationerror`,st,!1),L===null){let t=`webgl2`;if(L=Me(t,e),L===null)throw Me(t)?Error(`THREE.WebGLRenderer: Error creating WebGL context with your selected attributes.`):Error(`THREE.WebGLRenderer: Error creating WebGL context.`)}it()}catch(e){throw t.removeEventListener(`webglcontextlost`,at,!1),t.removeEventListener(`webglcontextrestored`,ot,!1),t.removeEventListener(`webglcontextcreationerror`,st,!1),H(`WebGLRenderer: `+e.message),e}function it(){Ne=new Vs(L),Ne.init(),tt=new du(L,Ne),Pe=new gs(L,Ne,e,tt),R=new lu(L,Ne),Pe.reversedDepthBuffer&&h&&R.buffers.depth.setReversed(!0),re=L.createFramebuffer(),ie=L.createFramebuffer(),ae=L.createFramebuffer(),Fe=new Ws(L),z=new Ul,B=new uu(L,Ne,R,z,Pe,tt,Fe),Le=new Bs(F),Re=new cs(L),nt=new ms(L,Re),ze=new Hs(L,Re,Fe,nt),Be=new Ks(L,ze,Re,nt,Fe),Qe=new Gs(L,Pe,B),qe=new _s(z),Ve=new Hl(F,Le,Ne,Pe,nt,qe),Ue=new vu(F,z),We=new ql,Ge=new eu(Ne),Xe=new ps(F,Le,R,Be,x,s),Ye=new cu(F,Be,Pe),rt=new yu(L,Fe,Pe,R),$e=new hs(L,Ne,Fe),et=new Us(L,Ne,Fe),Fe.programs=Ve.programs,F.capabilities=Pe,F.extensions=Ne,F.properties=z,F.renderLists=We,F.shadowMap=Ye,F.state=R,F.info=Fe}S!==1009&&(P=new Js(S,t.width,t.height,o,r,i));let U=new hu(F,L);this.xr=U,this.getContext=function(){return L},this.getContextAttributes=function(){return L.getContextAttributes()},this.forceContextLoss=function(){let e=Ne.get(`WEBGL_lose_context`);e&&e.loseContext()},this.forceContextRestore=function(){let e=Ne.get(`WEBGL_lose_context`);e&&e.restoreContext()},this.getPixelRatio=function(){return _e},this.setPixelRatio=function(e){e!==void 0&&(_e=e,this.setSize(he,ge,!1))},this.getSize=function(e){return e.set(he,ge)},this.setSize=function(e,n,r=!0){if(U.isPresenting){V(`WebGLRenderer: Can't change size while VR device is presenting.`);return}he=e,ge=n,t.width=Math.floor(e*_e),t.height=Math.floor(n*_e),r===!0&&(t.style.width=e+`px`,t.style.height=n+`px`),P!==null&&P.setSize(t.width,t.height),this.setViewport(0,0,e,n)},this.getDrawingBufferSize=function(e){return e.set(he*_e,ge*_e).floor()},this.setDrawingBufferSize=function(e,n,r){he=e,ge=n,_e=r,t.width=Math.floor(e*r),t.height=Math.floor(n*r),this.setViewport(0,0,e,n)},this.setEffects=function(e){if(S===1009){H(`WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.`);return}if(e){for(let t=0;t<e.length;t++)if(e[t].isOutputPass===!0){V(`WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.`);break}}P.setEffects(e||[])},this.getCurrentViewport=function(e){return e.copy(ue)},this.getViewport=function(e){return e.copy(be)},this.setViewport=function(e,t,n,r){e.isVector4?be.set(e.x,e.y,e.z,e.w):be.set(e,t,n,r),R.viewport(ue.copy(be).multiplyScalar(_e).round())},this.getScissor=function(e){return e.copy(xe)},this.setScissor=function(e,t,n,r){e.isVector4?xe.set(e.x,e.y,e.z,e.w):xe.set(e,t,n,r),R.scissor(de.copy(xe).multiplyScalar(_e).round())},this.getScissorTest=function(){return Se},this.setScissorTest=function(e){R.setScissorTest(Se=e)},this.setOpaqueSort=function(e){ve=e},this.setTransparentSort=function(e){ye=e},this.getClearColor=function(e){return e.copy(Xe.getClearColor())},this.setClearColor=function(){Xe.setClearColor(...arguments)},this.getClearAlpha=function(){return Xe.getClearAlpha()},this.setClearAlpha=function(){Xe.setClearAlpha(...arguments)},this.clear=function(e=!0,t=!0,n=!0){let r=0;if(e){let e=!1;if(I!==null){let t=I.texture.format;e=C.has(t)}if(e){let e=I.texture.type,t=w.has(e),n=Xe.getClearColor(),r=Xe.getClearAlpha(),i=n.r,a=n.g,o=n.b;t?(T[0]=i,T[1]=a,T[2]=o,T[3]=r,L.clearBufferuiv(L.COLOR,0,T)):(E[0]=i,E[1]=a,E[2]=o,E[3]=r,L.clearBufferiv(L.COLOR,0,E))}else r|=L.COLOR_BUFFER_BIT}t&&(r|=L.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),n&&(r|=L.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),r!==0&&L.clear(r)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(e){e.setRenderer(this),ne=e},this.dispose=function(){t.removeEventListener(`webglcontextlost`,at,!1),t.removeEventListener(`webglcontextrestored`,ot,!1),t.removeEventListener(`webglcontextcreationerror`,st,!1),Xe.dispose(),We.dispose(),Ge.dispose(),z.dispose(),Le.dispose(),Be.dispose(),nt.dispose(),rt.dispose(),Ve.dispose(),U.dispose(),U.removeEventListener(`sessionstart`,mt),U.removeEventListener(`sessionend`,ht),gt.stop()};function at(e){e.preventDefault(),Je(`WebGLRenderer: Context Lost.`),te=!0}function ot(){Je(`WebGLRenderer: Context Restored.`),te=!1;let e=Fe.autoReset,t=Ye.enabled,n=Ye.autoUpdate,r=Ye.needsUpdate,i=Ye.type;it(),Fe.autoReset=e,Ye.enabled=t,Ye.autoUpdate=n,Ye.needsUpdate=r,Ye.type=i}function st(e){H(`WebGLRenderer: A WebGL context could not be created. Reason: `,e.statusMessage)}function ct(e){let t=e.target;t.removeEventListener(`dispose`,ct),lt(t)}function lt(e){ut(e),z.remove(e)}function ut(e){let t=z.get(e).programs;t!==void 0&&(t.forEach(function(e){Ve.releaseProgram(e)}),e.isShaderMaterial&&Ve.releaseShaderCache(e))}this.renderBufferDirect=function(e,t,n,r,i,a){t===null&&(t=ke);let o=i.isMesh&&i.matrixWorld.determinantAffine()<0,s=W(e,t,n,r,i);R.setMaterial(r,o);let c=n.index,l=1;if(r.wireframe===!0){if(c=ze.getWireframeAttribute(n),c===void 0)return;l=2}let u=n.drawRange,d=n.attributes.position,f=u.start*l,p=(u.start+u.count)*l;a!==null&&(f=Math.max(f,a.start*l),p=Math.min(p,(a.start+a.count)*l)),c===null?d!=null&&(f=Math.max(f,0),p=Math.min(p,d.count)):(f=Math.max(f,0),p=Math.min(p,c.count));let m=p-f;if(m<0||m===1/0)return;nt.setup(i,r,s,n,c);let h,g=$e;if(c!==null&&(h=Re.get(c),g=et,g.setIndex(h)),i.isMesh)r.wireframe===!0?(R.setLineWidth(r.wireframeLinewidth*je()),g.setMode(L.LINES)):g.setMode(L.TRIANGLES);else if(i.isLine){let e=r.linewidth;e===void 0&&(e=1),R.setLineWidth(e*je()),i.isLineSegments?g.setMode(L.LINES):i.isLineLoop?g.setMode(L.LINE_LOOP):g.setMode(L.LINE_STRIP)}else i.isPoints?g.setMode(L.POINTS):i.isSprite&&g.setMode(L.TRIANGLES);if(i.isBatchedMesh){if(Ne.get(`WEBGL_multi_draw`))g.renderMultiDraw(i._multiDrawStarts,i._multiDrawCounts,i._multiDrawCount);else{let e=i._multiDrawStarts,t=i._multiDrawCounts,n=i._multiDrawCount,a=c?Re.get(c).bytesPerElement:1,o=z.get(r).currentProgram.getUniforms();for(let r=0;r<n;r++)o.setValue(L,`_gl_DrawID`,r),g.render(e[r]/a,t[r])}}else if(i.isInstancedMesh)g.renderInstances(f,m,i.count);else if(n.isInstancedBufferGeometry){let e=n._maxInstanceCount===void 0?1/0:n._maxInstanceCount,t=Math.min(n.instanceCount,e);g.renderInstances(f,m,t)}else g.render(f,m)};function dt(e,t,n,r){ne!==null&&e.isNodeMaterial&&ne.setObject(r,e),we===!0&&qe.setState(e,n,!1),e.transparent===!0&&e.side===2&&e.forceSinglePass===!1?(e.side=1,e.needsUpdate=!0,St(e,t,r),e.side=0,e.needsUpdate=!0,St(e,t,r),e.side=2):St(e,t,r)}this.compile=function(e,t,n=null){n===null&&(n=e),ne!==null&&ne.renderStart(e,t,n),M=Ge.get(n),M.init(t),N.push(M),n.traverseVisible(function(e){e.isLight&&e.layers.test(t.layers)&&(M.pushLight(e),e.castShadow&&M.pushShadow(e))}),e!==n&&e.traverseVisible(function(e){e.isLight&&e.layers.test(t.layers)&&(M.pushLight(e),e.castShadow&&M.pushShadow(e))}),M.setupLights(),ne!==null&&ne.updateLights(M.state.lightsArray),Te=this.localClippingEnabled,we=qe.init(this.clippingPlanes,Te),we===!0&&qe.setGlobalState(this.clippingPlanes,t),ne!==null&&Ye.render(M.state.shadowsArray,n,t);let r=new Set;return e.traverse(function(e){if(!(e.isMesh||e.isPoints||e.isLine||e.isSprite))return;let i=e.material;if(i){if(Array.isArray(i))for(let a=0;a<i.length;a++){let o=i[a];dt(o,n,t,e),r.add(o)}else dt(i,n,t,e),r.add(i)}}),M=N.pop(),ne!==null&&ne.renderEnd(),r},this.compileAsync=function(e,t,n=null){let r=this.compile(e,t,n);return new Promise(t=>{function n(){if(r.forEach(function(e){let t=z.get(e).currentProgram;(t===void 0||t.isReady())&&r.delete(e)}),r.size===0){t(e);return}setTimeout(n,10)}Ne.get(`KHR_parallel_shader_compile`)===null?setTimeout(n,10):n()})};let ft=null;function pt(e){ft&&ft(e)}function mt(){gt.stop()}function ht(){gt.start()}let gt=new ss;gt.setAnimationLoop(pt),typeof self<`u`&&gt.setContext(self),this.setAnimationLoop=function(e){ft=e,U.setAnimationLoop(e),e===null?gt.stop():gt.start()},U.addEventListener(`sessionstart`,mt),U.addEventListener(`sessionend`,ht),this.render=function(e,t){if(t!==void 0&&t.isCamera!==!0){H(`WebGLRenderer.render: camera is not an instance of THREE.Camera.`);return}if(te===!0)return;ne!==null&&ne.renderStart(e,t);let n=U.enabled===!0&&U.isPresenting===!0,r=P!==null&&(I===null||n)&&P.begin(F,I);if(e.matrixWorldAutoUpdate===!0&&e.updateMatrixWorld(),t.parent===null&&t.matrixWorldAutoUpdate===!0&&t.updateMatrixWorld(),U.enabled===!0&&U.isPresenting===!0&&(P===null||P.isCompositing()===!1)&&(U.cameraAutoUpdate===!0&&U.updateCamera(t),t=U.getCamera()),e.isScene===!0&&e.onBeforeRender(F,e,t,I),M=Ge.get(e,N.length),M.init(t),M.state.textureUnits=B.getTextureUnits(),N.push(M),Ee.multiplyMatrices(t.projectionMatrix,t.matrixWorldInverse),Ce.setFromProjectionMatrix(Ee,He,t.reversedDepth),Te=this.localClippingEnabled,we=qe.init(this.clippingPlanes,Te),k=We.get(e,ee.length),k.init(),ee.push(k),U.enabled===!0&&U.isPresenting===!0){let e=F.xr.getDepthSensingMesh();e!==null&&_t(e,t,-1/0,F.sortObjects)}_t(e,t,0,F.sortObjects),k.finish(),ne!==null&&ne.updateLights(M.state.lightsArray),F.sortObjects===!0&&k.sort(ve,ye),Ae=U.enabled===!1||U.isPresenting===!1||U.hasDepthSensing()===!1,Ae&&Xe.addToRenderList(k,e),this.info.render.frame++,this.info.autoReset===!0&&this.info.reset(),we===!0&&qe.beginShadows();let i=M.state.shadowsArray;if(Ye.render(i,e,t),we===!0&&qe.endShadows(),(r&&P.hasRenderPass())===!1){let n=k.opaque,r=k.transmissive;if(M.setupLights(),t.isArrayCamera){let i=t.cameras;if(r.length>0)for(let t=0,a=i.length;t<a;t++){let a=i[t];yt(n,r,e,a)}Ae&&Xe.render(e);for(let t=0,n=i.length;t<n;t++){let n=i[t];vt(k,e,n,n.viewport)}}else r.length>0&&yt(n,r,e,t),Ae&&Xe.render(e),vt(k,e,t)}I!==null&&se===0&&(B.updateMultisampleRenderTarget(I),B.updateRenderTargetMipmap(I)),r&&P.end(F),e.isScene===!0&&e.onAfterRender(F,e,t),nt.resetDefaultState(),ce=-1,le=null,N.pop(),N.length>0?(M=N[N.length-1],B.setTextureUnits(M.state.textureUnits),we===!0&&qe.setGlobalState(F.clippingPlanes,M.state.camera)):M=null,ee.pop(),k=ee.length>0?ee[ee.length-1]:null,ne!==null&&ne.renderEnd()};function _t(e,t,n,r){if(e.visible===!1)return;if(e.layers.test(t.layers)){if(e.isGroup)n=e.renderOrder;else if(e.isLOD)e.autoUpdate===!0&&e.update(t);else if(e.isLightProbeGrid)M.pushLightProbeGrid(e);else if(e.isLight)M.pushLight(e),e.castShadow&&M.pushShadow(e);else if(e.isSprite){if(!e.frustumCulled||e.intersectsFrustum(Ce)){r&&Oe.setFromMatrixPosition(e.matrixWorld).applyMatrix4(Ee);let i=Be.update(e),a=e.material;a.visible&&k.push(e,i,a,n,Oe.z,null,t)}}else if((e.isMesh||e.isLine||e.isPoints)&&(!e.frustumCulled||e.intersectsFrustum(Ce))){let i=Be.update(e),a=e.material;if(r&&(e.boundingSphere===void 0?(i.boundingSphere===null&&i.computeBoundingSphere(),Oe.copy(i.boundingSphere.center)):(e.boundingSphere===null&&e.computeBoundingSphere(),Oe.copy(e.boundingSphere.center)),Oe.applyMatrix4(e.matrixWorld).applyMatrix4(Ee)),Array.isArray(a)){let r=i.groups;for(let o=0,s=r.length;o<s;o++){let s=r[o],c=a[s.materialIndex];c&&c.visible&&k.push(e,i,c,n,Oe.z,s,t)}}else a.visible&&k.push(e,i,a,n,Oe.z,null,t)}}let i=e.children;for(let e=0,a=i.length;e<a;e++)_t(i[e],t,n,r)}function vt(e,t,n,r){let{opaque:i,transmissive:a,transparent:o}=e;M.setupLightsView(n),we===!0&&qe.setGlobalState(F.clippingPlanes,n),r&&R.viewport(ue.copy(r)),i.length>0&&bt(i,t,n),a.length>0&&bt(a,t,n),o.length>0&&bt(o,t,n),R.buffers.depth.setTest(!0),R.buffers.depth.setMask(!0),R.buffers.color.setMask(!0),R.setPolygonOffset(!1)}function yt(e,t,n,r){if((n.isScene===!0?n.overrideMaterial:null)!==null)return;if(M.state.transmissionRenderTarget[r.id]===void 0){let e=Ne.has(`EXT_color_buffer_half_float`)||Ne.has(`EXT_color_buffer_float`);M.state.transmissionRenderTarget[r.id]=new Kt(1,1,{generateMipmaps:!0,type:e?g:l,minFilter:c,samples:Math.max(4,Pe.samples),stencilBuffer:i,resolveDepthBuffer:!1,resolveStencilBuffer:!1,storeMultisampledDepthBuffer:!1,storeMultisampledStencilBuffer:!1,colorSpace:Nt.workingColorSpace})}let a=M.state.transmissionRenderTarget[r.id],o=r.viewport||ue;a.setSize(o.z*F.transmissionResolutionScale,o.w*F.transmissionResolutionScale);let s=F.getRenderTarget(),u=F.getActiveCubeFace(),d=F.getActiveMipmapLevel();F.setRenderTarget(a),F.getClearColor(pe),me=F.getClearAlpha(),me<1&&F.setClearColor(16777215,.5),F.clear(),Ae&&Xe.render(n);let f=F.toneMapping;F.toneMapping=0;let p=r.viewport;if(r.viewport!==void 0&&(r.viewport=void 0),M.setupLightsView(r),we===!0&&qe.setGlobalState(F.clippingPlanes,r),bt(e,n,r),B.updateMultisampleRenderTarget(a),B.updateRenderTargetMipmap(a),Ne.has(`WEBGL_multisampled_render_to_texture`)===!1){let e=!1;for(let i=0,a=t.length;i<a;i++){let{object:a,geometry:o,material:s,group:c}=t[i];if(s.side===2&&a.layers.test(r.layers)){let t=s.side;s.side=1,s.needsUpdate=!0,xt(a,n,r,o,s,c),s.side=t,s.needsUpdate=!0,e=!0}}e===!0&&(B.updateMultisampleRenderTarget(a),B.updateRenderTargetMipmap(a))}F.setRenderTarget(s,u,d),F.setClearColor(pe,me),p!==void 0&&(r.viewport=p),F.toneMapping=f}function bt(e,t,n){let r=t.isScene===!0?t.overrideMaterial:null;for(let i=0,a=e.length;i<a;i++){let a=e[i],{object:o,geometry:s,group:c}=a,l=a.material;l.allowOverride===!0&&r!==null&&(l=r),o.layers.test(n.layers)&&xt(o,t,n,s,l,c)}}function xt(e,t,n,r,i,a){ne!==null&&i.isNodeMaterial&&ne.setObject(e,i),e.onBeforeRender(F,t,n,r,i,a),e.modelViewMatrix.multiplyMatrices(n.matrixWorldInverse,e.matrixWorld),e.normalMatrix.getNormalMatrix(e.modelViewMatrix),i.onBeforeRender(F,t,n,r,e,a),i.transparent===!0&&i.side===2&&i.forceSinglePass===!1?(i.side=1,i.needsUpdate=!0,F.renderBufferDirect(n,t,r,i,e,a),i.side=0,i.needsUpdate=!0,F.renderBufferDirect(n,t,r,i,e,a),i.side=2):F.renderBufferDirect(n,t,r,i,e,a),e.onAfterRender(F,t,n,r,i,a)}function St(e,t,n){t.isScene!==!0&&(t=ke);let r=z.get(e),i=M.state.lights,a=M.state.shadowsArray,o=i.state.version,s=Ve.getParameters(e,i.state,a,t,n,M.state.lightProbeGridArray),c=Ve.getProgramCacheKey(s),l=r.programs;r.environment=e.isMeshStandardMaterial||e.isMeshLambertMaterial||e.isMeshPhongMaterial?t.environment:null,r.fog=t.fog;let u=e.isMeshStandardMaterial||e.isMeshLambertMaterial&&!e.envMap||e.isMeshPhongMaterial&&!e.envMap;r.envMap=Le.get(e.envMap||r.environment,u),r.envMapRotation=r.environment!==null&&e.envMap===null?t.environmentRotation:e.envMapRotation,l===void 0&&(e.addEventListener(`dispose`,ct),l=new Map,r.programs=l);let d=l.get(c);if(d!==void 0){if(r.currentProgram===d&&r.lightsStateVersion===o)return wt(e,s),d}else s.uniforms=Ve.getUniforms(e),ne!==null&&e.isNodeMaterial&&ne.build(e,n,s),e.onBeforeCompile(s,F),d=Ve.acquireProgram(s,c),l.set(c,d),r.uniforms=s.uniforms;let f=r.uniforms;return(!e.isShaderMaterial&&!e.isRawShaderMaterial||e.clipping===!0)&&(f.clippingPlanes=qe.uniform),wt(e,s),r.needsLights=Dt(e),r.lightsStateVersion=o,r.needsLights&&(f.ambientLightColor.value=i.state.ambient,f.lightProbe.value=i.state.probe,f.sunLights.value=i.state.sun,f.sunLightShadows.value=i.state.sunShadow,f.directionalLights.value=i.state.directional,f.directionalLightShadows.value=i.state.directionalShadow,f.spotLights.value=i.state.spot,f.spotLightShadows.value=i.state.spotShadow,f.rectAreaLights.value=i.state.rectArea,f.ltc_1.value=i.state.rectAreaLTC1,f.ltc_2.value=i.state.rectAreaLTC2,f.pointLights.value=i.state.point,f.pointLightShadows.value=i.state.pointShadow,f.hemisphereLights.value=i.state.hemi,f.sunShadowMatrix.value=i.state.sunShadowMatrix,f.sunShadowCascade.value=i.state.sunShadowCascade,f.directionalShadowMatrix.value=i.state.directionalShadowMatrix,f.spotLightMatrix.value=i.state.spotLightMatrix,f.spotLightMap.value=i.state.spotLightMap,f.pointShadowMatrix.value=i.state.pointShadowMatrix),r.lightProbeGrid=M.state.lightProbeGridArray.length>0,r.currentProgram=d,r.uniformsList=null,d}function Ct(e){if(e.uniformsList===null){let t=e.currentProgram.getUniforms();e.uniformsList=tl.seqWithValue(t.seq,e.uniforms)}return e.uniformsList}function wt(e,t){let n=z.get(e);n.outputColorSpace=t.outputColorSpace,n.batching=t.batching,n.batchingColor=t.batchingColor,n.instancing=t.instancing,n.instancingColor=t.instancingColor,n.instancingMorph=t.instancingMorph,n.skinning=t.skinning,n.morphTargets=t.morphTargets,n.morphNormals=t.morphNormals,n.morphColors=t.morphColors,n.morphTargetsCount=t.morphTargetsCount,n.numClippingPlanes=t.numClippingPlanes,n.numIntersection=t.numClipIntersection,n.vertexAlphas=t.vertexAlphas,n.vertexTangents=t.vertexTangents,n.toneMapping=t.toneMapping}function Tt(e,t){if(e.length===0)return null;if(e.length===1)return e[0].texture===null?null:e[0];D.setFromMatrixPosition(t.matrixWorld);for(let t=0,n=e.length;t<n;t++){let n=e[t];if(n.texture!==null&&n.boundingBox.containsPoint(D))return n}return null}function W(e,t,n,r,i){t.isScene!==!0&&(t=ke),B.resetTextureUnits();let a=t.fog,o=r.isMeshStandardMaterial||r.isMeshLambertMaterial||r.isMeshPhongMaterial?t.environment:null,s=I===null?F.outputColorSpace:I.isXRRenderTarget===!0?I.texture.colorSpace:Nt.workingColorSpace,c=r.isMeshStandardMaterial||r.isMeshLambertMaterial&&!r.envMap||r.isMeshPhongMaterial&&!r.envMap,l=Le.get(r.envMap||o,c),u=r.vertexColors===!0&&!!n.attributes.color&&n.attributes.color.itemSize===4,d=!!n.attributes.tangent&&(!!r.normalMap||r.anisotropy>0),f=!!n.morphAttributes.position,p=!!n.morphAttributes.normal,m=!!n.morphAttributes.color,h=0;r.toneMapped&&(I===null||I.isXRRenderTarget===!0)&&(h=F.toneMapping);let g=n.morphAttributes.position||n.morphAttributes.normal||n.morphAttributes.color,_=g===void 0?0:g.length,v=z.get(r),y=M.state.lights;if(we===!0&&(Te===!0||e!==le)){let t=e===le&&r.id===ce;qe.setState(r,e,t)}let b=!1;r.version===v.__version?v.needsLights&&v.lightsStateVersion!==y.state.version?b=!0:v.outputColorSpace===s?i.isBatchedMesh&&v.batching===!1||!i.isBatchedMesh&&v.batching===!0||i.isBatchedMesh&&v.batchingColor===!0&&i._colorsTexture===null||i.isBatchedMesh&&v.batchingColor===!1&&i._colorsTexture!==null||i.isInstancedMesh&&v.instancing===!1||!i.isInstancedMesh&&v.instancing===!0||i.isSkinnedMesh&&v.skinning===!1||!i.isSkinnedMesh&&v.skinning===!0||i.isInstancedMesh&&v.instancingColor===!0&&i.instanceColor===null||i.isInstancedMesh&&v.instancingColor===!1&&i.instanceColor!==null||i.isInstancedMesh&&v.instancingMorph===!0&&i.morphTexture===null||i.isInstancedMesh&&v.instancingMorph===!1&&i.morphTexture!==null?b=!0:v.envMap===l?r.fog===!0&&v.fog!==a||v.numClippingPlanes!==void 0&&(v.numClippingPlanes!==qe.numPlanes||v.numIntersection!==qe.numIntersection)?b=!0:v.vertexAlphas===u&&v.vertexTangents===d&&v.morphTargets===f&&v.morphNormals===p&&v.morphColors===m&&v.toneMapping===h&&v.morphTargetsCount===_?!!v.lightProbeGrid!=M.state.lightProbeGridArray.length>0&&(b=!0):b=!0:b=!0:b=!0:(b=!0,v.__version=r.version);let x=v.currentProgram;b===!0&&(x=St(r,t,i),ne&&r.isNodeMaterial&&ne.onUpdateProgram(r,x,v));let S=!1,C=!1,w=!1,T=x.getUniforms(),E=v.uniforms;if(R.useProgram(x.program)&&(S=!0,C=!0,w=!0),r.id!==ce&&(ce=r.id,C=!0),v.needsLights){let e=Tt(M.state.lightProbeGridArray,i);v.lightProbeGrid!==e&&(v.lightProbeGrid=e,C=!0)}if(S||le!==e){R.buffers.depth.getReversed()&&e.reversedDepth!==!0&&(e._reversedDepth=!0,e.updateProjectionMatrix()),T.setValue(L,`projectionMatrix`,e.projectionMatrix),T.setValue(L,`viewMatrix`,e.matrixWorldInverse);let t=T.map.cameraPosition;t!==void 0&&t.setValue(L,De.setFromMatrixPosition(e.matrixWorld)),Pe.logarithmicDepthBuffer&&T.setValue(L,`logDepthBufFC`,2/(Math.log(e.far+1)/Math.LN2)),(r.isMeshPhongMaterial||r.isMeshToonMaterial||r.isMeshLambertMaterial||r.isMeshBasicMaterial||r.isMeshStandardMaterial||r.isShaderMaterial)&&T.setValue(L,`isOrthographic`,e.isOrthographicCamera===!0),le!==e&&(le=e,C=!0,w=!0)}if(v.needsLights&&(y.state.sunShadowMap.length>0&&T.setValue(L,`sunShadowMap`,y.state.sunShadowMap,B),y.state.directionalShadowMap.length>0&&T.setValue(L,`directionalShadowMap`,y.state.directionalShadowMap,B),y.state.spotShadowMap.length>0&&T.setValue(L,`spotShadowMap`,y.state.spotShadowMap,B),y.state.pointShadowMap.length>0&&T.setValue(L,`pointShadowMap`,y.state.pointShadowMap,B)),i.isSkinnedMesh){T.setOptional(L,i,`bindMatrix`),T.setOptional(L,i,`bindMatrixInverse`);let e=i.skeleton;e&&(e.boneTexture===null&&e.computeBoneTexture(),T.setValue(L,`boneTexture`,e.boneTexture,B))}i.isBatchedMesh&&(T.setOptional(L,i,`batchingTexture`),T.setValue(L,`batchingTexture`,i._matricesTexture,B),T.setOptional(L,i,`batchingIdTexture`),T.setValue(L,`batchingIdTexture`,i._indirectTexture,B),T.setOptional(L,i,`batchingColorTexture`),i._colorsTexture!==null&&T.setValue(L,`batchingColorTexture`,i._colorsTexture,B));let D=n.morphAttributes;if((D.position!==void 0||D.normal!==void 0||D.color!==void 0)&&Qe.update(i,n,x),(C||v.receiveShadow!==i.receiveShadow)&&(v.receiveShadow=i.receiveShadow,T.setValue(L,`receiveShadow`,i.receiveShadow)),(r.isMeshStandardMaterial||r.isMeshLambertMaterial||r.isMeshPhongMaterial)&&r.envMap===null&&t.environment!==null&&(E.envMapIntensity.value=t.environmentIntensity),E.dfgLUT!==void 0&&(E.dfgLUT.value=Su()),C){if(T.setValue(L,`toneMappingExposure`,F.toneMappingExposure),v.needsLights&&Et(E,w),a&&r.fog===!0&&Ue.refreshFogUniforms(E,a),Ue.refreshMaterialUniforms(E,r,_e,ge,M.state.transmissionRenderTarget[e.id]),v.needsLights&&v.lightProbeGrid){let e=v.lightProbeGrid;E.probesSH.value=e.texture,E.probesMin.value.copy(e.boundingBox.min),E.probesMax.value.copy(e.boundingBox.max),E.probesResolution.value.copy(e.resolution)}tl.upload(L,Ct(v),E,B)}if(r.isShaderMaterial&&r.uniformsNeedUpdate===!0&&(tl.upload(L,Ct(v),E,B),r.uniformsNeedUpdate=!1),r.isSpriteMaterial&&T.setValue(L,`center`,i.center),T.setValue(L,`modelViewMatrix`,i.modelViewMatrix),T.setValue(L,`normalMatrix`,i.normalMatrix),T.setValue(L,`modelMatrix`,i.matrixWorld),r.uniformsGroups!==void 0){let e=r.uniformsGroups;for(let t=0,n=e.length;t<n;t++){let n=e[t];rt.update(n,x),rt.bind(n,x)}}return x}function Et(e,t){e.ambientLightColor.needsUpdate=t,e.lightProbe.needsUpdate=t,e.sunLights.needsUpdate=t,e.sunLightShadows.needsUpdate=t,e.directionalLights.needsUpdate=t,e.directionalLightShadows.needsUpdate=t,e.pointLights.needsUpdate=t,e.pointLightShadows.needsUpdate=t,e.spotLights.needsUpdate=t,e.spotLightShadows.needsUpdate=t,e.rectAreaLights.needsUpdate=t,e.hemisphereLights.needsUpdate=t}function Dt(e){return e.isMeshLambertMaterial||e.isMeshToonMaterial||e.isMeshPhongMaterial||e.isMeshStandardMaterial||e.isShadowMaterial||e.isShaderMaterial&&e.lights===!0}this.getActiveCubeFace=function(){return oe},this.getActiveMipmapLevel=function(){return se},this.getRenderTarget=function(){return I},this.setRenderTargetTextures=function(e,t,n){let r=z.get(e);r.__autoAllocateDepthBuffer=e.resolveDepthBuffer===!1,r.__autoAllocateDepthBuffer===!1&&(r.__useRenderToTexture=!1),z.get(e.texture).__webglTexture=t,z.get(e.depthTexture).__webglTexture=r.__autoAllocateDepthBuffer?void 0:n,r.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(e,t){let n=z.get(e);n.__webglFramebuffer=t,n.__useDefaultFramebuffer=t===void 0},this.setRenderTarget=function(e,t=0,n=0){I=e,oe=t,se=n;let r=null,i=!1,a=!1;if(e){let o=z.get(e);if(o.__useDefaultFramebuffer!==void 0){R.bindFramebuffer(L.FRAMEBUFFER,o.__webglFramebuffer),ue.copy(e.viewport),de.copy(e.scissor),fe=e.scissorTest,R.viewport(ue),R.scissor(de),R.setScissorTest(fe),ce=-1;return}if(o.__webglFramebuffer===void 0)B.setupRenderTarget(e);else if(o.__hasExternalTextures)B.rebindTextures(e,z.get(e.texture).__webglTexture,z.get(e.depthTexture).__webglTexture);else if(e.depthBuffer){let t=e.depthTexture;if(o.__boundDepthTexture!==t){if(t!==null&&z.has(t)&&(e.width!==t.image.width||e.height!==t.image.height))throw Error(`THREE.WebGLRenderer: Attached DepthTexture is initialized to the incorrect size.`);B.setupDepthRenderbuffer(e)}}let s=e.texture;(s.isData3DTexture||s.isDataArrayTexture||s.isCompressedArrayTexture)&&(a=!0);let c=z.get(e).__webglFramebuffer;e.isWebGLCubeRenderTarget?(r=Array.isArray(c[t])?c[t][n]:c[t],i=!0):r=e.samples>0&&B.useMultisampledRTT(e)===!1?z.get(e).__webglMultisampledFramebuffer:Array.isArray(c)?c[n]:c,ue.copy(e.viewport),de.copy(e.scissor),fe=e.scissorTest}else ue.copy(be).multiplyScalar(_e).floor(),de.copy(xe).multiplyScalar(_e).floor(),fe=Se;if(n!==0&&(r=re),R.bindFramebuffer(L.FRAMEBUFFER,r)&&R.drawBuffers(e,r),R.viewport(ue),R.scissor(de),R.setScissorTest(fe),i){let r=z.get(e.texture);L.framebufferTexture2D(L.FRAMEBUFFER,L.COLOR_ATTACHMENT0,L.TEXTURE_CUBE_MAP_POSITIVE_X+t,r.__webglTexture,n)}else if(a){let r=t;for(let t=0;t<e.textures.length;t++){let i=z.get(e.textures[t]);L.framebufferTextureLayer(L.FRAMEBUFFER,L.COLOR_ATTACHMENT0+t,i.__webglTexture,n,r)}}else if(e!==null&&n!==0){let t=z.get(e.texture);L.framebufferTexture2D(L.FRAMEBUFFER,L.COLOR_ATTACHMENT0,L.TEXTURE_2D,t.__webglTexture,n)}ce=-1};function Ot(e){let t=z.get(e);return(t.__readFormat!==e.format||t.__readType!==e.type)&&(t.__readFormat=e.format,t.__readType=e.type,t.__formatReadable=Pe.textureFormatReadable(e.format),t.__typeReadable=Pe.textureTypeReadable(e.type)),t}this.readRenderTargetPixels=function(e,t,n,r,i,a,o,s=0){if(!(e&&e.isWebGLRenderTarget)){H(`WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.`);return}let c=z.get(e).__webglFramebuffer;if(e.isWebGLCubeRenderTarget&&o!==void 0&&(c=c[o]),c){R.bindFramebuffer(L.FRAMEBUFFER,c);try{let o=e.textures[s],c=o.format,l=o.type;e.textures.length>1&&L.readBuffer(L.COLOR_ATTACHMENT0+s);let u=Ot(o);if(u.__formatReadable===!1){H(`WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.`);return}if(u.__typeReadable===!1){H(`WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.`);return}t>=0&&t<=e.width-r&&n>=0&&n<=e.height-i&&L.readPixels(t,n,r,i,tt.convert(c),tt.convert(l),a)}finally{let e=I===null?null:z.get(I).__webglFramebuffer;R.bindFramebuffer(L.FRAMEBUFFER,e)}}},this.readRenderTargetPixelsAsync=async function(e,t,n,r,i,a,o,s=0){if(!(e&&e.isWebGLRenderTarget))throw Error(`THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.`);let c=z.get(e).__webglFramebuffer;if(e.isWebGLCubeRenderTarget&&o!==void 0&&(c=c[o]),c){if(t>=0&&t<=e.width-r&&n>=0&&n<=e.height-i){R.bindFramebuffer(L.FRAMEBUFFER,c);let o=e.textures[s],l=o.format,u=o.type;e.textures.length>1&&L.readBuffer(L.COLOR_ATTACHMENT0+s);let d=Ot(o);if(d.__formatReadable===!1)throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.`);if(d.__typeReadable===!1)throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.`);let f=L.createBuffer();L.bindBuffer(L.PIXEL_PACK_BUFFER,f),L.bufferData(L.PIXEL_PACK_BUFFER,a.byteLength,L.STREAM_READ),L.readPixels(t,n,r,i,tt.convert(l),tt.convert(u),0),L.bindBuffer(L.PIXEL_PACK_BUFFER,null);let p=I===null?null:z.get(I).__webglFramebuffer;R.bindFramebuffer(L.FRAMEBUFFER,p);let m=L.fenceSync(L.SYNC_GPU_COMMANDS_COMPLETE,0);return L.flush(),await Ze(L,m,4),L.bindBuffer(L.PIXEL_PACK_BUFFER,f),L.getBufferSubData(L.PIXEL_PACK_BUFFER,0,a),L.bindBuffer(L.PIXEL_PACK_BUFFER,null),L.deleteBuffer(f),L.deleteSync(m),a}throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.`)}},this.copyFramebufferToTexture=function(e,t=null,n=0){let r=2**-n,i=Math.floor(e.image.width*r),a=Math.floor(e.image.height*r),o=t===null?0:t.x,s=t===null?0:t.y;B.setTexture2D(e,0),L.copyTexSubImage2D(L.TEXTURE_2D,n,0,0,o,s,i,a),R.unbindTexture()},this.copyTextureToTexture=function(e,t,n=null,r=null,i=0,a=0){let o,s,c,l,u,d,f,p,m,h=e.isCompressedTexture?e.mipmaps[a]:e.image;if(n!==null)o=n.max.x-n.min.x,s=n.max.y-n.min.y,c=n.isBox3?n.max.z-n.min.z:1,l=n.min.x,u=n.min.y,d=n.isBox3?n.min.z:0;else{let t=2**-i;o=Math.floor(h.width*t),s=Math.floor(h.height*t),c=e.isDataArrayTexture?h.depth:e.isData3DTexture?Math.floor(h.depth*t):1,l=0,u=0,d=0}r===null?(f=0,p=0,m=0):(f=r.x,p=r.y,m=r.z);let g=tt.convert(t.format),_=tt.convert(t.type),v;t.isData3DTexture?(B.setTexture3D(t,0),v=L.TEXTURE_3D):t.isDataArrayTexture||t.isCompressedArrayTexture?(B.setTexture2DArray(t,0),v=L.TEXTURE_2D_ARRAY):(B.setTexture2D(t,0),v=L.TEXTURE_2D),R.activeTexture(L.TEXTURE0),R.pixelStorei(L.UNPACK_FLIP_Y_WEBGL,t.flipY),R.pixelStorei(L.UNPACK_PREMULTIPLY_ALPHA_WEBGL,t.premultiplyAlpha),R.pixelStorei(L.UNPACK_ALIGNMENT,t.unpackAlignment);let y=R.getParameter(L.UNPACK_ROW_LENGTH),b=R.getParameter(L.UNPACK_IMAGE_HEIGHT),x=R.getParameter(L.UNPACK_SKIP_PIXELS),S=R.getParameter(L.UNPACK_SKIP_ROWS),C=R.getParameter(L.UNPACK_SKIP_IMAGES);R.pixelStorei(L.UNPACK_ROW_LENGTH,h.width),R.pixelStorei(L.UNPACK_IMAGE_HEIGHT,h.height),R.pixelStorei(L.UNPACK_SKIP_PIXELS,l),R.pixelStorei(L.UNPACK_SKIP_ROWS,u),R.pixelStorei(L.UNPACK_SKIP_IMAGES,d);let w=e.isDataArrayTexture||e.isData3DTexture,T=t.isDataArrayTexture||t.isData3DTexture;if(e.isDepthTexture){let n=z.get(e),r=z.get(t),h=z.get(n.__renderTarget),g=z.get(r.__renderTarget);R.bindFramebuffer(L.READ_FRAMEBUFFER,h.__webglFramebuffer),R.bindFramebuffer(L.DRAW_FRAMEBUFFER,g.__webglFramebuffer);for(let n=0;n<c;n++)w&&(L.framebufferTextureLayer(L.READ_FRAMEBUFFER,L.COLOR_ATTACHMENT0,z.get(e).__webglTexture,i,d+n),L.framebufferTextureLayer(L.DRAW_FRAMEBUFFER,L.COLOR_ATTACHMENT0,z.get(t).__webglTexture,a,m+n)),L.blitFramebuffer(l,u,o,s,f,p,o,s,L.DEPTH_BUFFER_BIT,L.NEAREST);R.bindFramebuffer(L.READ_FRAMEBUFFER,null),R.bindFramebuffer(L.DRAW_FRAMEBUFFER,null)}else if(i!==0||e.isRenderTargetTexture||z.has(e)){let n=z.get(e),r=z.get(t);R.bindFramebuffer(L.READ_FRAMEBUFFER,ie),R.bindFramebuffer(L.DRAW_FRAMEBUFFER,ae);for(let e=0;e<c;e++)w?L.framebufferTextureLayer(L.READ_FRAMEBUFFER,L.COLOR_ATTACHMENT0,n.__webglTexture,i,d+e):L.framebufferTexture2D(L.READ_FRAMEBUFFER,L.COLOR_ATTACHMENT0,L.TEXTURE_2D,n.__webglTexture,i),T?L.framebufferTextureLayer(L.DRAW_FRAMEBUFFER,L.COLOR_ATTACHMENT0,r.__webglTexture,a,m+e):L.framebufferTexture2D(L.DRAW_FRAMEBUFFER,L.COLOR_ATTACHMENT0,L.TEXTURE_2D,r.__webglTexture,a),i===0?T?L.copyTexSubImage3D(v,a,f,p,m+e,l,u,o,s):L.copyTexSubImage2D(v,a,f,p,l,u,o,s):L.blitFramebuffer(l,u,o,s,f,p,o,s,L.COLOR_BUFFER_BIT,L.NEAREST);R.bindFramebuffer(L.READ_FRAMEBUFFER,null),R.bindFramebuffer(L.DRAW_FRAMEBUFFER,null)}else T?e.isDataTexture||e.isData3DTexture?L.texSubImage3D(v,a,f,p,m,o,s,c,g,_,h.data):t.isCompressedArrayTexture?L.compressedTexSubImage3D(v,a,f,p,m,o,s,c,g,h.data):L.texSubImage3D(v,a,f,p,m,o,s,c,g,_,h):e.isDataTexture?L.texSubImage2D(L.TEXTURE_2D,a,f,p,o,s,g,_,h.data):e.isCompressedTexture?L.compressedTexSubImage2D(L.TEXTURE_2D,a,f,p,h.width,h.height,g,h.data):L.texSubImage2D(L.TEXTURE_2D,a,f,p,o,s,g,_,h);R.pixelStorei(L.UNPACK_ROW_LENGTH,y),R.pixelStorei(L.UNPACK_IMAGE_HEIGHT,b),R.pixelStorei(L.UNPACK_SKIP_PIXELS,x),R.pixelStorei(L.UNPACK_SKIP_ROWS,S),R.pixelStorei(L.UNPACK_SKIP_IMAGES,C),a===0&&t.generateMipmaps&&L.generateMipmap(v),R.unbindTexture()},this.initRenderTarget=function(e){z.get(e).__webglFramebuffer===void 0&&B.setupRenderTarget(e)},this.initTexture=function(e){e.isCubeTexture?B.setTextureCube(e,0):e.isData3DTexture?B.setTexture3D(e,0):e.isDataArrayTexture||e.isCompressedArrayTexture?B.setTexture2DArray(e,0):B.setTexture2D(e,0),R.unbindTexture()},this.resetState=function(){oe=0,se=0,I=null,R.reset(),nt.reset()},typeof __THREE_DEVTOOLS__<`u`&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent(`observe`,{detail:this}))}get coordinateSystem(){return He}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;let t=this.getContext();t.drawingBufferColorSpace=Nt._getDrawingBufferColorSpace(e),t.unpackColorSpace=Nt._getUnpackColorSpace()}},wu=1/60,Tu=4.2,Eu=1600,Du=.6,Ou=.5,ku=.25,Au=.5,ju=.45,Mu=.5,Nu=9.8,Pu=.22,Fu=.12,Iu=.0024,Lu=.055,Ru=.9,zu=.3,Bu=.55,Vu=.1,Hu=.25,Uu=null,Wu,Gu,Ku=null,qu,Ju=null,Yu=0;function Xu(){if(!Uu){Uu=new AudioContext,Wu=Uu.createGain(),Wu.gain.value=.8,Wu.connect(Uu.destination),Gu=Uu.createBuffer(1,Uu.sampleRate*2,Uu.sampleRate);let e=Gu.getChannelData(0);for(let t=0;t<e.length;t++)e[t]=Math.random()*2-1}Uu.state===`suspended`&&Uu.resume()}function Zu(){return Uu?(Ju||(Ju=Uu.createMediaStreamDestination(),Wu.connect(Ju)),Ju.stream):null}function Qu(){return Uu&&Uu.state===`running`?Uu:null}function $u(e,t,n,r,i=`bandpass`,a){let o=Qu();if(!o)return;let s=o.currentTime,c=o.createBufferSource();c.buffer=Gu;let l=o.createBiquadFilter();l.type=i,l.frequency.setValueAtTime(t,s),a&&l.frequency.exponentialRampToValueAtTime(a,s+e),l.Q.value=n;let u=o.createGain();u.gain.setValueAtTime(r,s),u.gain.exponentialRampToValueAtTime(.001,s+e),c.connect(l).connect(u).connect(Wu),c.start(s,Math.random()*1.5,e+.05)}function ed(e,t,n,r=`sine`,i,a=0){let o=Qu();if(!o)return;let s=o.currentTime+a,c=o.createOscillator();c.type=r,c.frequency.setValueAtTime(e,s),i&&c.frequency.exponentialRampToValueAtTime(i,s+t);let l=o.createGain();l.gain.setValueAtTime(1e-4,s),l.gain.exponentialRampToValueAtTime(n,s+.01),l.gain.exponentialRampToValueAtTime(.001,s+t),c.connect(l).connect(Wu),c.start(s),c.stop(s+t+.02)}function td(){let e=Qu();if(!e||Ku)return;let t=e.createBufferSource();t.buffer=Gu,t.loop=!0,qu=e.createBiquadFilter(),qu.type=`lowpass`,qu.frequency.value=300,Ku=e.createGain(),Ku.gain.value=0,t.connect(qu).connect(Ku).connect(Wu),t.start()}function nd(){Ku&&Uu&&Ku.gain.setTargetAtTime(0,Uu.currentTime,.1)}function rd(e,t){let n=Qu();if(!n)return;if(e.phase===`run`&&td(),Ku){let t=e.phase===`run`&&!e.airborne?e.v/38:0;Ku.gain.setTargetAtTime(t*.22,n.currentTime,.05),qu.frequency.setTargetAtTime(180+t*520,n.currentTime,.05)}let r=e.phase===`run`?e.stack.danger():0;Yu-=t,r>.6&&Yu<=0&&(ed(900+r*500,.06,.12,`square`),Yu=.35-r*.2)}function id(e,t){switch(e.type){case`pickup`:{let e=t.stack.items.length;ed(380*1.09**e,.16,.25,`triangle`,760*1.09**e);break}case`lost`:$u(.25,900,1.5,.6,`bandpass`,300),ed(420,.35,.18,`sawtooth`,110),e.lost.items.some(e=>e.key===`eggs`)&&setTimeout(()=>$u(.3,1400,.8,.5,`bandpass`,500),350);break;case`hit`:if(e.kind===`cone`)$u(.12,1800,3,.5);else if(e.kind===`pigeons`)for(let e=0;e<5;e++)$u(.08,2500+e*300,4,.2);else $u(.18,300,1,.7,`lowpass`),ed(110,.2,.4,`sine`,45);break;case`honk`:ed(350,.3,.12,`square`),ed(440,.3,.12,`square`),ed(350,.35,.12,`square`,void 0,.4),ed(440,.35,.12,`square`,void 0,.4);break;case`launch`:$u(.6,400,1,.4,`bandpass`,2400);break;case`land`:$u(.2,250,1,.8,`lowpass`),ed(90,.25,.5,`sine`,40);break;case`pat`:ed(700,.05,.2,`sine`),ed(620,.05,.2,`sine`,void 0,.08);break;case`nearMiss`:$u(.35,600,2,.4,`bandpass`,2e3);break;case`curb`:$u(.15,3e3,2,.25);break;case`wipeout`:nd(),$u(.8,600,.6,1,`lowpass`,120),ed(70,.6,.6,`sine`,30);for(let e=0;e<6;e++)setTimeout(()=>$u(.1,1500+Math.random()*2e3,3,.3),120+e*90);break;case`finish`:nd(),[523.25,659.25,783.99,1046.5].forEach((e,t)=>ed(e,.35,.22,`triangle`,void 0,t*.12))}}var ad=new URLSearchParams(location.search),od={on:ad.has(`capture`),record:ad.has(`record`),style:ad.get(`style`)??`greedyCareful`,hook:ad.get(`hook`)??``,cta:ad.get(`cta`)??``},sd=1080,cd=1920,ld=`"Arial Black", "Helvetica Neue", Arial, sans-serif`,ud=[`video/mp4;codecs=avc1.42E01F,mp4a.40.2`,`video/mp4`,`video/webm;codecs=vp9,opus`,`video/webm`],dd=class{canvas=document.createElement(`canvas`);g;recorder=null;chunks=[];result=null;constructor(){this.canvas.width=sd,this.canvas.height=cd,this.g=this.canvas.getContext(`2d`)}start(){if(this.recorder||typeof MediaRecorder>`u`)return;let e=this.canvas.captureStream(60);Zu()?.getAudioTracks().forEach(t=>e.addTrack(t));let t=ud.find(e=>MediaRecorder.isTypeSupported(e));this.recorder=new MediaRecorder(e,{mimeType:t,videoBitsPerSecond:8e6}),this.chunks=[],this.recorder.ondataavailable=e=>e.data.size&&this.chunks.push(e.data),this.recorder.start(250)}stop(e){let t=this.recorder;t&&(this.recorder=null,t.onstop=()=>{let n=t.mimeType||`video/webm`,r=URL.createObjectURL(new Blob(this.chunks,{type:n})),i=document.createElement(`a`);i.href=r,i.download=`${e}.${n.startsWith(`video/mp4`)?`mp4`:`webm`}`,i.click(),setTimeout(()=>URL.revokeObjectURL(r),2e4)},t.stop())}draw(e,t,n,r){let i=this.g,a=Math.max(sd/e.width,cd/e.height),o=e.width*a,s=e.height*a;i.drawImage(e,(sd-o)/2,(cd-s)/2,o,s),this.text(`$${t.bankedTotal.toLocaleString()}`,48,110,92,`#ffd23f`,`left`),this.text(`${t.stack.items.length} 🛒`,1032,110,80,`#ffffff`,`right`),r<n.bubbleUntil&&n.bubbleText&&this.bubble(n.bubbleText);let c=0;for(let e of[...n.toasts].reverse()){let t=r-e.born;e.cls.startsWith(`feed`)?(i.globalAlpha=Math.max(0,Math.min(1,(1.4-t)/.35)),this.text(e.text,48,200+c++*56,46,e.cls.includes(`bad`)?`#ff8a98`:`#ffffff`,`left`)):e.cls===`zone`?(i.globalAlpha=Math.max(0,Math.min(1,(2.2-t)/.4)),this.text(e.text,sd/2,cd*.32,104,`#ffffff`,`center`)):(i.globalAlpha=Math.max(0,1-t/1.1),this.text(e.text,sd/2,330-t*60,e.cls===`big`?84:70,e.cls===`bad`?`#ff8a98`:e.cls===`big`?`#ffd23f`:`#ffffff`,`center`)),i.globalAlpha=1}n.hookText&&this.wrapped(n.hookText,cd*.33,92),this.result&&this.endCard(this.result)}text(e,t,n,r,i,a){let o=this.g;o.font=`${r}px ${ld}`,o.textAlign=a,o.lineJoin=`round`,o.lineWidth=r*.2,o.strokeStyle=`#1b1c26`,o.strokeText(e,t,n),o.fillStyle=i,o.fillText(e,t,n)}wrap(e,t){let n=[],r=``;for(let i of e.split(` `)){let e=r?`${r} ${i}`:i;this.g.measureText(e).width>t&&r?(n.push(r),r=i):r=e}return n.push(r),n}wrapped(e,t,n){this.g.font=`${n}px ${ld}`,this.wrap(e,960).forEach((e,r)=>this.text(e,sd/2,t+r*n*1.1,n,`#ffffff`,`center`))}bubble(e){let t=this.g;t.font=`48px ${ld}`;let n=this.wrap(e,800),r=Math.max(...n.map(e=>t.measureText(e).width))+60,i=40+n.length*58,a=1560-i;t.fillStyle=`#fffaf0`,t.strokeStyle=`#1b1c26`,t.lineWidth=8,t.beginPath(),t.roundRect(170,a,r,i,30),t.fill(),t.stroke(),t.fillStyle=`#1b1c26`,t.textAlign=`left`,n.forEach((e,n)=>t.fillText(e,200,a+68+n*58)),t.font=`110px serif`,t.fillText(`👵`,40,a+100)}endCard(e){let t=this.g;t.fillStyle=`rgba(16,19,28,0.55)`,t.fillRect(0,0,sd,cd);let n=e.wipeout?`WIPEOUT!`:`HOME SAFE!`;this.text(n,sd/2,cd*.36,130,`#e8455a`,`center`),this.text(`🏆 ${e.tallest}-item tower · ${e.tallestMeters}m`,sd/2,cd*.47,60,`#ffffff`,`center`),this.text(`${e.banked.length} cash-outs`,sd/2,cd*.52,52,`#ffffff`,`center`),this.text(`$${e.score.toLocaleString()}`,sd/2,cd*.62,140,`#ffd23f`,`center`);let r=od.cta||(e.wipeout||e.lost.length?`Can YOU get the eggs home?`:`Think you can beat Grandma?`);this.wrapped(r,cd*.74,76)}},fd=.5,pd=30,md=.6,hd=class{segments;frames=[];length;starts=[];constructor(e,t=[0,0,0]){this.segments=e;let n=[...t],r=0,i=e[0]&&`pitch`in e[0]?e[0].pitch:0,a=0;for(let t of e){this.starts.push(a);let e=t.kind===`loop`?2*Math.PI*t.radius:t.len,o=Math.max(1,Math.round(e/fd)),s=i;for(let a=0;a<o;a++){let c=(a+.5)/o,l=0,u=0,d=0,f=!1,p=0;switch(t.kind){case`straight`:i=yd(s,t.pitch,bd(c));break;case`curve`:l=t.turn/e*(Math.PI/2)*Math.sin(Math.PI*c),u=t.bank===void 0?xd(l*pd,-.6,md):t.bank*Math.sin(Math.PI*c),i=yd(s,t.pitch,bd(c));break;case`roller`:i=yd(s,t.pitch,bd(c))+Math.sin(c*Math.PI*2*t.bumps)*(t.height*Math.PI*t.bumps)/e;break;case`loop`:f=!0,i=s+c*Math.PI*2,p=t.shift/o}let m=gd(n,r,i,u),h=this.frames.length?this.frames[this.frames.length-1].pitch:i;d=Sd(i-h)/fd,this.frames.push({...m,curve:l,bend:d,inLoop:f}),r+=l*fd,n=_d(n,vd(m.fwd,fd)),p&&(n=_d(n,vd(m.flatRight,p)))}t.kind===`loop`&&(i=s),a+=o*fd}this.length=a}at(e){let t=xd(Math.round(e/fd),0,this.frames.length-1);return this.frames[t]}posAt(e){let t=xd(e/fd,0,this.frames.length-1),n=Math.floor(t),r=this.frames[n],i=this.frames[Math.min(n+1,this.frames.length-1)],a=t-n;return[yd(r.pos[0],i.pos[0],a),yd(r.pos[1],i.pos[1],a),yd(r.pos[2],i.pos[2],a)]}point(e,t=0,n=0){let r=this.at(e);return _d(_d(this.posAt(e),vd(r.right,t)),vd(r.up,n))}flatPoint(e,t=0,n=0){let r=this.at(e),i=this.posAt(e);return[i[0]+r.flatRight[0]*t,i[1]+n,i[2]+r.flatRight[2]*t]}heightAt(e){return this.posAt(e)[1]}};function gd(e,t,n,r){let i=Math.cos(t),a=Math.sin(t),o=Math.cos(n),s=Math.sin(n),c=[-o*a,s,-o*i],l=[s*a,o,s*i],u=[i,0,-a],d=Math.cos(r),f=Math.sin(r),p=_d(vd(u,d),vd(l,f)),m=_d(vd(l,d),vd(u,-f));return{pos:[...e],fwd:c,up:m,right:p,flatRight:u,yaw:t,pitch:n,bank:r}}var _d=(e,t)=>[e[0]+t[0],e[1]+t[1],e[2]+t[2]],vd=(e,t)=>[e[0]*t,e[1]*t,e[2]*t],yd=(e,t,n)=>e+(t-e)*n,bd=e=>e*e*(3-2*e),xd=(e,t,n)=>Math.max(t,Math.min(n,e)),Sd=e=>Math.atan2(Math.sin(e),Math.cos(e)),Cd=320,wd=[{key:`hill`,title:`🏘️ NOB HILL`,start:-200,end:Cd,weights:{line:3,zigzag:2,cones:2,potholes:1.5,bump:1,birds:1,parked:1,car:.4,roadblock:3.5},look:{skyTop:6272242,skyBottom:13496063,fog:12576511,fogNear:70,fogFar:330,sun:16777215,sunIntensity:2.6,ambient:16777215,ambientIntensity:1.6}},{key:`market`,title:`🛒 MEGAMART`,start:Cd,end:Cd*2,weights:{bonanza:4,line:2,zigzag:1.5,cans:2.5,cones:1,overhead:2.5,parked:1,car:1,roadblock:3.5},look:{skyTop:16052712,skyBottom:16052712,fog:15855074,fogNear:40,fogFar:180,sun:16775920,sunIntensity:1.6,ambient:16777215,ambientIntensity:2.2}},{key:`lanterns`,title:`🏮 LANTERN STREET`,start:Cd*2,end:Cd*3,weights:{line:2.5,zigzag:2,bonanza:1.5,overhead:2.5,birds:1.5,parked:1.5,car:1,potholes:1,roadblock:4.5},look:{skyTop:2827353,skyBottom:14250634,fog:7031416,fogNear:50,fogFar:260,sun:16763296,sunIntensity:1.3,ambient:16757960,ambientIntensity:1.4}},{key:`roadwork`,title:`🚧 ROAD WORK`,start:Cd*3,end:Cd*4,weights:{cones:3,potholes:3,bump:2,overhead:2,line:2,zigzag:1.5,car:1.2,roadblock:5.5},look:{skyTop:5074872,skyBottom:16757596,fog:15247464,fogNear:60,fogFar:300,sun:16765066,sunIntensity:2.2,ambient:16769728,ambientIntensity:1.4}},{key:`boardwalk`,title:`🏖️ THE BOARDWALK`,start:Cd*4,end:Cd*5+400,weights:{line:2.5,zigzag:2,bonanza:1.5,birds:2.5,cones:1.5,potholes:1,parked:.8,overhead:1,roadblock:4.5},look:{skyTop:3817359,skyBottom:16747100,fog:16227190,fogNear:60,fogFar:320,sun:16753515,sunIntensity:2.4,ambient:16762536,ambientIntensity:1.3}}];function Td(e){return wd.find(t=>e<t.end)??wd[wd.length-1]}function Ed(e){return wd.indexOf(Td(e))}var Dd=600,Od=class{mesh;ps=[];m=new Yt;q=new Et;e=new on;s=new G;groundAt=()=>-1/0;constructor(e){this.mesh=new ci(new vi(1,1,1),new ro,Dd),this.mesh.instanceMatrix.setUsage(Ve),this.mesh.count=0,this.mesh.frustumCulled=!1,e.add(this.mesh)}burst(e,t,n){for(let r=0;r<t&&this.ps.length<Dd;r++){let t=new G(Math.random()-.5,Math.random()*.6+(n.up??.4),Math.random()-.5).normalize(),r=(n.life??.8)*(.6+Math.random()*.6);this.ps.push({pos:e.clone().add(n.spread?new G((Math.random()-.5)*n.spread.x,(Math.random()-.5)*n.spread.y,(Math.random()-.5)*n.spread.z):new G),vel:t.multiplyScalar(n.speed*(.4+Math.random()*.8)),life:r,maxLife:r,size:(n.size??.12)*(.6+Math.random()*.8),gravity:n.gravity??12,color:new J(n.colors[Math.floor(Math.random()*n.colors.length)])})}}update(e){let t=0;this.ps=this.ps.filter(t=>(t.life-=e)>0);for(let n of this.ps){n.vel.y-=n.gravity*e,n.pos.addScaledVector(n.vel,e);let r=this.groundAt(n.pos);n.pos.y<r&&(n.pos.y=r,n.vel.multiplyScalar(.4),n.vel.y=Math.abs(n.vel.y)*.3);let i=Math.min(1,n.life/(n.maxLife*.5));this.e.set(n.life*7,n.life*5,0),this.q.setFromEuler(this.e),this.m.compose(n.pos,this.q,this.s.setScalar(n.size*i)),this.mesh.setMatrixAt(t,this.m),this.mesh.setColorAt(t,n.color),t++}this.mesh.count=t,this.mesh.instanceMatrix.needsUpdate=!0,this.mesh.instanceColor&&(this.mesh.instanceColor.needsUpdate=!0)}},kd={watermelon:{name:`Watermelon`,emoji:`🍉`,h:.55,w:.66,mass:5,grip:.7,pts:40},turkey:{name:`Frozen Turkey`,emoji:`🦃`,h:.42,w:.62,mass:6,grip:.85,pts:70},eggs:{name:`Eggs`,emoji:`🥚`,h:.2,w:.64,mass:.8,grip:1,pts:120,fragile:!0},cereal:{name:`Cereal`,emoji:`🥣`,h:.6,w:.5,mass:.6,grip:.9,pts:60},tp:{name:`Toilet Paper`,emoji:`🧻`,h:.48,w:.56,mass:.5,grip:.95,pts:30,cushion:!0}};Object.keys(kd);function Ad(t,n,r,i){let a=document.createElement(`canvas`);a.width=t,a.height=n,r(a.getContext(`2d`));let o=new mi(a);return o.colorSpace=Ie,o.anisotropy=4,i&&(o.wrapS=o.wrapT=e,o.repeat.set(...i)),o}var jd={road:e=>Ad(256,256,e=>{e.fillStyle=`#4a4f5c`,e.fillRect(0,0,256,256);for(let t=0;t<900;t++)e.fillStyle=Math.random()<.5?`rgba(255,255,255,0.05)`:`rgba(0,0,0,0.08)`,e.fillRect(Math.random()*256,Math.random()*256,2,2);e.fillStyle=`#f2c94c`,e.fillRect(122,0,12,140),e.fillStyle=`#e9e9e9`,e.fillRect(6,0,6,256),e.fillRect(244,0,6,256)},[1,e/10]),sidewalk:e=>Ad(128,128,e=>{e.fillStyle=`#cfc8b8`,e.fillRect(0,0,128,128),e.strokeStyle=`#b4ad9c`,e.lineWidth=3,e.strokeRect(0,0,128,128)},[1,e/3]),windows:()=>Ad(128,256,e=>{e.fillStyle=`#ffffff`,e.fillRect(0,0,128,256);for(let t=20;t<250;t+=58)for(let n=14;n<120;n+=40)e.fillStyle=`#9fd0f2`,e.fillRect(n,t,24,34),e.fillStyle=`rgba(255,255,255,0.6)`,e.fillRect(n+3,t+3,7,28),e.fillStyle=`rgba(0,0,0,0.15)`,e.fillRect(n-3,t+34,30,5)}),watermelon:()=>Ad(256,128,e=>{e.fillStyle=`#3c9d45`,e.fillRect(0,0,256,128),e.fillStyle=`#20622a`;for(let t=0;t<256;t+=32){e.beginPath(),e.moveTo(t,0);for(let n=0;n<=128;n+=8)e.lineTo(t+8+Math.sin(n*.3)*4,n);e.lineTo(t+16,128),e.lineTo(t,128),e.fill()}}),cereal:()=>Ad(128,200,e=>{e.fillStyle=`#e8455a`,e.fillRect(0,0,128,200),e.fillStyle=`#ffd23f`,e.fillRect(0,0,128,44),e.fillStyle=`#e8455a`,e.font=`bold 30px "Arial Black", Arial`,e.textAlign=`center`,e.fillText(`LOOPY`,64,34),e.fillStyle=`#ffffff`,e.beginPath(),e.ellipse(64,140,46,22,0,0,Math.PI),e.fill();let t=[`#ffd23f`,`#3bb273`,`#3f7fe0`,`#ff8c1a`];for(let n=0;n<14;n++)e.strokeStyle=t[n%4],e.lineWidth=6,e.beginPath(),e.arc(30+n*37%70,95+n*23%45,7,0,Math.PI*2),e.stroke()}),tpLabel:()=>Ad(256,64,e=>{e.fillStyle=`#3f7fe0`,e.fillRect(0,0,256,64),e.fillStyle=`#ffffff`,e.font=`bold 34px "Arial Black", Arial`,e.textAlign=`center`,e.fillText(`SOFTEE ×12`,128,46)}),basket:()=>Ad(64,64,e=>{e.clearRect(0,0,64,64),e.strokeStyle=`#d7dde4`,e.lineWidth=5,e.strokeRect(2,2,60,60),e.beginPath(),e.moveTo(32,0),e.lineTo(32,64),e.moveTo(0,32),e.lineTo(64,32),e.stroke()},[6,4]),chevrons:()=>Ad(128,128,e=>{e.fillStyle=`#c99b5f`,e.fillRect(0,0,128,128),e.fillStyle=`#ff7a1a`;for(let t=-64;t<192;t+=64)e.beginPath(),e.moveTo(0,t+40),e.lineTo(64,t),e.lineTo(128,t+40),e.lineTo(128,t+64),e.lineTo(64,t+24),e.lineTo(0,t+64),e.fill()},[2,2]),bumpStripes:()=>Ad(128,16,e=>{for(let t=0;t<128;t+=32)e.fillStyle=`#ffd23f`,e.fillRect(t,0,16,16),e.fillStyle=`#1b1c26`,e.fillRect(t+16,0,16,16)},[8,1]),tile:e=>Ad(128,128,e=>{e.fillStyle=`#eef0f2`,e.fillRect(0,0,128,128),e.fillStyle=`#dde1e6`,e.fillRect(0,0,64,64),e.fillRect(64,64,64,64),e.strokeStyle=`#c3c9d0`,e.lineWidth=2,e.strokeRect(0,0,64,64),e.strokeRect(64,64,64,64)},[5,e/2]),brick:e=>Ad(128,128,e=>{e.fillStyle=`#8a3b33`,e.fillRect(0,0,128,128);for(let t=0;t<128;t+=16)for(let n=t/16%2?-16:0;n<128;n+=32)e.fillStyle=[`#b5503f`,`#a4473a`,`#c05a45`][(n+t)/16%3|0],e.fillRect(n+1,t+1,30,14)},[4,e/2]),dirt:e=>Ad(128,128,e=>{e.fillStyle=`#a57b4f`,e.fillRect(0,0,128,128);for(let t=0;t<700;t++)e.fillStyle=[`#8e6640`,`#b98c5c`,`#7a5634`,`#c9a171`][t%4],e.fillRect(Math.random()*128,Math.random()*128,3,3);e.fillStyle=`rgba(60,40,20,0.25)`,e.fillRect(24,0,14,128),e.fillRect(90,0,14,128)},[2,e/6]),planks:e=>Ad(128,128,e=>{for(let t=0;t<128;t+=16)e.fillStyle=[`#c08a55`,`#b27d4a`,`#c9955f`,`#a8733f`][t/16%4],e.fillRect(0,t,128,15),e.fillStyle=`#5a3a1e`,e.fillRect(0,t+15,128,1),e.fillRect(t*37%100+10,t+7,3,3)},[2,e/2]),sand:()=>Ad(128,128,e=>{e.fillStyle=`#f1d9a5`,e.fillRect(0,0,128,128);for(let t=0;t<500;t++)e.fillStyle=Math.random()<.5?`#e5c98f`:`#f8e6bb`,e.fillRect(Math.random()*128,Math.random()*128,2,2)},[12,12]),shelves:()=>Ad(256,256,e=>{e.fillStyle=`#e9edf1`,e.fillRect(0,0,256,256);let t=[`#e8455a`,`#3f7fe0`,`#ffd23f`,`#3bb273`,`#ff8c1a`,`#8e5bd6`,`#ffffff`,`#f7c6c7`];for(let n=0;n<4;n++){let r=n*64;e.fillStyle=`#9aa5b1`,e.fillRect(0,r+58,256,6);for(let i=4;i<250;){let a=12+(i*7+n*13)%20,o=26+(i*11+n*5)%26;e.fillStyle=t[(i+n*3)%t.length],e.fillRect(i,r+58-o,a-2,o),e.fillStyle=`rgba(255,255,255,0.35)`,e.fillRect(i+2,r+58-o+4,a-8,5),i+=a}}},[3,1]),sign:(e,t,n,r=512,i=128)=>Ad(r,i,a=>{a.fillStyle=t,a.fillRect(0,0,r,i),a.strokeStyle=n,a.lineWidth=8,a.strokeRect(8,8,r-16,i-16),a.fillStyle=n,a.font=`bold ${Math.round(i*.45)}px "Arial Black", Arial`,a.textAlign=`center`,a.textBaseline=`middle`,a.fillText(e,r/2,i/2+4,r-40)}),canLabel:()=>Ad(128,64,e=>{e.fillStyle=`#d63a4e`,e.fillRect(0,0,128,64),e.fillStyle=`#ffffff`,e.fillRect(0,22,128,20),e.fillStyle=`#d63a4e`,e.font=`bold 16px Arial`,e.textAlign=`center`,e.fillText(`BEANS`,64,38)}),beachBall:()=>Ad(256,128,e=>{let t=[`#e8455a`,`#ffffff`,`#3f7fe0`,`#ffffff`,`#ffd23f`,`#ffffff`];t.forEach((n,r)=>{e.fillStyle=n,e.fillRect(r*256/t.length,0,256/t.length+1,128)})}),grass:()=>Ad(128,128,e=>{e.fillStyle=`#6cc04a`,e.fillRect(0,0,128,128);for(let t=0;t<400;t++)e.fillStyle=Math.random()<.5?`#5aad3b`:`#7fd35b`,e.fillRect(Math.random()*128,Math.random()*128,2,5)},[8,8])},Md=new Map;function Z(e,t={}){let n=e+JSON.stringify(t);if(!t.map&&Md.has(n))return Md.get(n);let r=new ro({color:e,...t});return t.map||Md.set(n,r),r}function Q(e,t,n=0,r=0,i=0){let a=new Xr(e,t);return a.position.set(n,r,i),a.castShadow=!0,a}var $=(e,t,n)=>new vi(e,t,n),Nd=(e,t,n,r=12)=>new bi(e,t,n,r),Pd=(e,t=14)=>new Ga(e,t,Math.max(8,t*.7)),Fd={},Id=e=>Fd[e]??=jd[e]();function Ld(e){let t=kd[e],n=new q;switch(e){case`watermelon`:{let e=Q(Pd(.5,18),Z(16777215,{map:Id(`watermelon`)}));e.scale.set(t.w,t.h,t.w*.75),n.add(e);break}case`turkey`:{let e=Q(Pd(.5,16),Z(14722138));e.scale.set(t.w,t.h,t.w*.8),n.add(e);for(let e of[-1,1]){let t=Q(Nd(.05,.09,.3),Z(13668165),e*.16,.08,-.26);t.rotation.x=-1.1,n.add(t),n.add(Q(Pd(.06,8),Z(16777215),e*.16,.2,-.38))}let r=Q(Pd(.52,16),Z(16777215,{transparent:!0,opacity:.18}));r.scale.copy(e.scale),n.add(r);break}case`eggs`:n.add(Q($(t.w,t.h*.7,.34),Z(13352870),0,-t.h*.15,0));for(let e=0;e<6;e++){let r=Q(Pd(.07,10),Z(e%3?16774111:15785152),-.22+e%3*.22,t.h*.25,e<3?-.08:.08);r.scale.y=1.25,n.add(r)}break;case`cereal`:{let e=Z(16777215,{map:Id(`cereal`)}),r=Z(14039630);n.add(Q($(t.w,t.h,.18),[r,r,Z(16765503),r,e,e]));break}case`tp`:{let e=Z(16448250);for(let r=0;r<6;r++)n.add(Q(Nd(.13,.13,t.h*.92,14),e,-.14+r%2*.28,0,-.26+Math.floor(r/2)*.26));let r=Q($(t.w+.02,.12,.8),Z(16777215,{map:Id(`tpLabel`)}),0,.02,0);n.add(r);break}}return n}var Rd=.55,zd=.42,Bd=-.5;function Vd(){let e=new q,t=Z(13226458),n=Z(16777215,{map:Id(`basket`),transparent:!0,alphaTest:.5,side:2}),r=1.2,i=1.8,a=.62,o=Rd;e.add(Q($(r,.04,i),t,0,o,0));let s=new Va(i,a);for(let t of[-1,1]){let i=Q(s,n,t*r/2,.8600000000000001,0);i.rotation.y=Math.PI/2,e.add(i)}e.add(Q(new Va(r,a),n,0,.8600000000000001,-1.8/2)),e.add(Q(new Va(r,.72),n,0,.91,i/2));for(let n of[-1,1])e.add(Q($(.05,.05,i),t,n*r/2,1.17,0));e.add(Q($(r,.05,.05),t,0,1.17,-1.8/2));let c=Q(Nd(.045,.045,1.3),Z(15222106),0,1.42,1.12);c.rotation.z=Math.PI/2,e.add(c);for(let n of[-1,1]){let i=Q($(.04,.35,.3),t,n*r/2,1.27,1);i.rotation.x=-.6,e.add(i)}e.add(Q($(r*.9,.04,i*.9),t,0,.2,0)),e.add(Q($(r*.8,.04,.35),t,0,.22,1.25));for(let[n,a]of[[-1,-1],[1,-1],[-1,1],[1,1]]){e.add(Q($(.04,.45000000000000007,.04),t,n*r*.42,.65/2,a*i*.42));let o=Q(Nd(.1,.1,.07,12),Z(2237741),n*r*.42,.1,a*i*.42);o.rotation.z=Math.PI/2,o.name=`wheel`,e.add(o)}return e}function Hd(){let e=new q,t=new q;e.add(t);let n=Z(15910821),r=Z(12098528);for(let e of[-1,1])t.add(Q(Nd(.065,.06,.5),Z(14268576),e*.11,.25,0)),t.add(Q($(.13,.08,.22),Z(2761504),e*.11,.04,-.04));t.add(Q(Nd(.2,.32,.44,14),Z(9321326),0,.68,0)),t.add(Q(Nd(.21,.23,.46,14),r,0,1.1,0)),t.add(Q(Pd(.22,12),r,0,1.32,0));for(let e=0;e<9;e++){let n=-Math.PI*.15-e/8*Math.PI*.7;t.add(Q(Pd(.022,6),Z(16777215),Math.cos(n)*.18,1.39,Math.sin(n)*.18))}let i=new q;i.position.set(0,1.62,0),i.scale.setScalar(1.25),i.add(Q(Pd(.17,14),n));let a=Z(14343651);i.add(Q(Pd(.185,14),a,0,.04,.03)),i.add(Q(Pd(.12,10),a,0,.21,.07));for(let e of[-1,1])i.add(Q(new Ka(.05,.012,6,14),Z(8007214),e*.065,0,-.16));i.add(Q(Pd(.03,8),Z(15245450),0,-.04,-.17)),t.add(i);let o=e=>{let i=new q;return i.position.set(e*.25,1.36,0),i.add(Q(Nd(.06,.055,.52),r,0,-.24,0)),i.add(Q(Pd(.065,8),n,0,-.52,0)),t.add(i),i},s=o(-1),c=o(1),l=Q($(.24,.2,.09),Z(12986943),0,-.62,0);return s.add(l),{root:e,body:t,armL:s,armR:c,head:i}}function Ud(){let e=new q;return e.add(Q($(.5,.06,.5),Z(2761504),0,.03,0)),e.add(Q(new xi(.2,.7,14),Z(16742938),0,.4,0)),e.add(Q(Nd(.12,.155,.12,14),Z(16777215),0,.42,0)),e}function Wd(){let e=new q,t=new Xr(new yi(.75,16),Z(2040103));t.rotation.x=-Math.PI/2,t.scale.set(1,.75,1),t.position.y=.02,e.add(t);let n=new Xr(new Ha(.72,.9,16),Z(3817032));return n.rotation.x=-Math.PI/2,n.scale.set(1,.75,1),n.position.y=.015,e.add(n),e}function Gd(e){let t=new q,n=Z(16777215,{map:jd.bumpStripes()});return t.add(Q($(e,.16,.7),n,0,.08,0)),t}function Kd(e){let t=new q,n=Z(e),r=Z(2968171);t.add(Q($(4.2,.7,1.9),n,0,.65,0)),t.add(Q($(2.3,.62,1.7),n,-.2,1.3,0)),t.add(Q($(2.35,.46,1.72),r,-.2,1.32,0));for(let e of[-1,1]){t.add(Q($(.06,.18,.4),Z(16774852),2.1,.75,e*.6)),t.add(Q($(.06,.16,.36),Z(15222106),-2.1,.75,e*.6));for(let n of[-1.35,1.35]){let r=Q(Nd(.36,.36,.28,14),Z(1776678),n,.36,e*.9);r.rotation.x=Math.PI/2,t.add(r)}}return t}function qd(){let e=new q,t=Z(9080732),n=Q(Pd(.14,10),t);n.scale.set(.9,.8,1.3),e.add(n),e.add(Q(Pd(.08,8),Z(7109260),0,.12,-.14)),e.add(Q(new xi(.025,.07,6),Z(16751146),0,.11,-.23));for(let t of[-1,1]){let n=Q($(.22,.02,.16),Z(10133675),t*.14,.05,.02);n.name=t<0?`wingL`:`wingR`,e.add(n)}return e}function Jd(e,t,n){let r=new q,i=new $i;i.moveTo(0,0),i.lineTo(e,0),i.lineTo(e,t),i.closePath();let a=new La(i,{depth:n,bevelEnabled:!1});a.translate(0,0,-n/2),a.rotateY(Math.PI/2);let o=Q(a,[Z(9071172),Z(16777215,{map:jd.chevrons()})]);return o.receiveShadow=!0,r.add(o),r}function Yd(){let e=new q;e.add(Q($(9,4.5,7),Z(16769971),0,2.25,0));let t=Q(new xi(6.6,3,4),Z(12735821),0,6,0);t.rotation.y=Math.PI/4,t.scale.set(1,1,.8),e.add(t),e.add(Q($(1.4,2.4,.1),Z(7028516),0,1.2,3.52));for(let t of[-2.8,2.8])e.add(Q($(1.6,1.3,.1),Z(10473714),t,2.6,3.52)),e.add(Q($(1.8,.15,.2),Z(16777215),t,1.9,3.55));return e.add(Q(Nd(.05,.05,1.1),Z(7028516),5.5,.55,5)),e.add(Q($(.35,.3,.5),Z(4161504),5.5,1.2,5)),e}function Xd(){let e=new q,t=Z(16777215,{map:jd.sign(`⚠ WET`,`#ffd23f`,`#1b1c26`,256,256)});for(let n of[-1,1]){let r=Q($(.5,.7,.03),[Z(16765503),Z(16765503),Z(16765503),Z(16765503),t,t],0,.36,n*.14);r.rotation.x=n*.35,e.add(r)}return e}function Zd(){let e=new q,t=Z(16777215,{map:jd.bumpStripes()});e.add(Q($(1.1,.28,.1),t,0,.75,0));for(let t of[-.45,.45])e.add(Q($(.08,.9,.5),Z(16742938),t,.45,0));return e.add(Q(Pd(.07,8),Z(16765503,{emissive:8413184}),.45,.98,0)),e}function Qd(){let e=new q,t=Q(Pd(.38,16),Z(16777215,{map:jd.beachBall()}),0,.38,0);return t.rotation.z=.5,e.add(t),e}function $d(){let e=new q,t=Z(16777215,{map:jd.canLabel()}),n=Z(13226458),r=new bi(.1,.1,.24,12),i=.12;for(let a=4;a>=1;a--){for(let o=0;o<a;o++)for(let s of a>1?[-.1,.1]:[0])e.add(Q(r,[t,n,n],(o-(a-1)/2)*.21,i,s));i+=.24}return e}function ef(){let e=new q,t=new Xr(new yi(.8,14),Z(16777215));t.rotation.x=-Math.PI/2,t.scale.set(1.2,.8,1),t.position.y=.02,e.add(t);let n=Q($(.2,.35,.2),Z(8370416),.5,.12,.2);return n.rotation.z=Math.PI/2,e.add(n),e}function tf(){let e=new q,t=new Xr(new Va(1.4,.9),Z(2037262));return t.rotation.x=-Math.PI/2,t.position.y=.02,e.add(t),e}function nf(){let e=qd();return e.traverse(e=>{e instanceof Xr&&(e.material=e.name.startsWith(`wing`)?Z(12106950):Z(16777215))}),e.children[2].traverse(e=>e instanceof Xr&&(e.material=Z(16762138))),e}function rf(){let e=new q,t=Z(16762138);e.add(Q($(2.2,.8,1.4),t,-.4,.7,0)),e.add(Q($(.1,1.6,1.3),Z(2761504),-.9,1.9,0)),e.add(Q($(.1,.1,1.3),Z(2761504),.2,2.7,0));for(let t of[-.6,.6])e.add(Q($(.08,2.6,.08),Z(2761504),.2,1.4,t));e.add(Q($(.08,3,.1),Z(3817032),.8,1.5,0));for(let t of[-.35,.35])e.add(Q($(1.4,.06,.14),Z(7107459),1.5,.35,t));e.add(Q($(1.2,.9,1.2),Z(13208394),1.5,.85,0));for(let t of[-1.2,.4])for(let n of[-.7,.7]){let r=Q(Nd(.3,.3,.25,12),Z(1776678),t,.3,n);r.rotation.x=Math.PI/2,e.add(r)}return e}function af(){let e=Kd(16747546),t=Q(new bi(.8,.6,2.4,12),Z(15329769),-.7,1.9,0);return t.rotation.z=Math.PI/2-.25,e.add(t),e}function of(){let e=new q;e.add(Q($(1.9,.15,4),Z(10187846),0,.08,0));let t=[13208394,12155968,13933148];for(let n=0;n<3;n++)for(let r=-1;r<=1;r++)e.add(Q($(1.8,.6,1.25),Z(t[(n+r+3)%3]),0,.46+n*.62,r*1.3));return e}function sf(e,t,n,r){let i=new q,a=1.1,o=(e,t)=>i.add(Q($(.05,t-(n+a),.05),Z(3817032),e,(t+n+a)/2,0));switch(e){case`aisle`:i.add(Q($(t,a,.12),Z(16777215,{map:jd.sign(r,`#1f5fbf`,`#ffffff`,512,96)}),0,n+a/2,0)),o(-t/2+.3,n+8),o(t/2-.3,n+8);break;case`banner`:i.add(Q($(t,a,.06),Z(16777215,{map:jd.sign(r,`#c62a3f`,`#ffd23f`,512,96)}),0,n+a/2,0));for(let e of[-t/2,t/2])i.add(Q(Pd(.35,10),Z(15222106,{emissive:8392736}),e,n+a/2,0));o(-t/2+.2,n+6),o(t/2-.2,n+6);break;case`beam`:i.add(Q($(t,.2,.5),Z(14707226),0,n+.1,0)),i.add(Q($(t,.6,.1),Z(14707226),0,n+.5,0)),i.add(Q($(t,.2,.5),Z(14707226),0,n+.9,0));for(let e of[-t/3,t/3])i.add(Q($(.04,14,.04),Z(1776678),e,n+8,0));break;case`surf`:i.add(Q($(t,a,.06),Z(16777215,{map:jd.sign(r,`#1aa6b7`,`#ffffff`,512,96)}),0,n+a/2,0));for(let e of[-t/2,t/2])i.add(Q(Nd(.08,.08,n+a),Z(16777215),e,(n+a)/2,0))}return i}function cf(e,t,n){let r=new q,i=Z(n?14278114:15921126),a=(60-e)/2;for(let t of[-1,1])r.add(Q($(a,18,1),i,t*(e/2+a/2),9,0));if(r.add(Q($(e,18-t,1),i,0,t+(18-t)/2,0)),r.add(Q($(60,1.2,1.2),Z(15222106),0,17.4,0)),n)r.add(Q($(8,1.4,.3),Z(16777215,{map:jd.sign(`EXIT →`,`#3bb273`,`#ffffff`,512,96)}),0,t+1.2,-.7));else{let e=Q($(18,3.2,.3),Z(16777215,{map:jd.sign(`MEGAMART`,`#e8455a`,`#ffffff`,1024,180)}),0,t+3,.7);r.add(e)}let o=Z(10134961);for(let n of[-1,1])r.add(Q($(.4,t,1.2),o,e/2*n,t/2,0));r.add(Q($(e,.4,1.2),o,0,t,0));let s=Z(12576511,{transparent:!0,opacity:.45}),c=()=>Q($(e/2,t-.4,.12),s),l=c(),u=c();return l.position.set(-e/4,(t-.4)/2,0),u.position.set(e/4,(t-.4)/2,0),r.add(l,u),{group:r,left:l,right:u}}function lf(){let e=new q,t=Z(10187846);for(let n=0;n<6;n++)e.add(Q(Nd(.16,.2,1.1,8),t,Math.sin(n*.35)*.4,.55+n*1.05,0));let n=new G(Math.sin(1.75)*.4,6.6,0);for(let t=0;t<7;t++){let r=Q($(.5,.06,2.4),Z(3843162),n.x,n.y,n.z);r.rotation.set(.45,t/7*Math.PI*2,0),r.geometry.translate(0,0,1.1),e.add(r)}return e}function uf(e){let t=new q;return t.add(Q(Nd(.04,.04,2.4),Z(16777215),0,1.2,0)),t.add(Q(new xi(1.3,.6,10),Z(e),0,2.5,0)),t}function df(){let e=new q,t=Z(16762138);return e.add(Q($(1.2,34,1.2),t,0,17,0)),e.add(Q($(26,1,1),t,-6,34,0)),e.add(Q($(3,2.4,2),Z(7107459),6,33,0)),e.add(Q($(2,2,2),Z(3817032),0,35.5,0)),e.add(Q($(.05,14,.05),Z(1776678),-16,27,0)),e}function ff(e,t){let n=Hd();return n.root.traverse(n=>{if(!(n instanceof Xr))return;let r=n.material;r.color?.getHex()===12098528?n.material=Z(e):r.color?.getHex()===9321326&&(n.material=Z(t))}),n.armL.rotation.set(-1.2,0,-.4),n.armR.rotation.set(-1.2,0,.4),n.root.userData.arms=[n.armL,n.armR],n.root}function pf(e){let t=new q,n=Z(16765503,{emissive:12615680});for(let r=0;r<3;r++){let i=new $i;i.moveTo(-e/2,0),i.lineTo(0,1.2),i.lineTo(e/2,0),i.lineTo(e/2,-.6),i.lineTo(0,.6),i.lineTo(-e/2,-.6),i.closePath();let a=new Xr(new Ua(i),n);a.rotation.x=-Math.PI/2,a.position.set(0,.03,-r*1.6+1.6),t.add(a)}return t}function mf(e,t,n){let r=new q,i=Z(3817032),a=e/2+.4;for(let e of[-a,a])r.add(Q(Nd(.2,.25,t+2.4,8),i,e,(t+2.4)/2,0));r.add(Q($(a*2,.3,.3),i,0,t+2.3,0));let o=(n,a,o,s)=>{let c=Z(16777215,{map:jd.sign(n,a,o,512,160)});r.add(Q($(e/2-.3,2,.3),[i,i,i,i,c,c],s,t+1.1,0))};return o(`💰 CASH OUT`,`#ffd23f`,`#1b1c26`,n*e/4),o(`KEEP STACKING`,`#3bb273`,`#ffffff`,-n*e/4),r}var hf=(e,t=new G)=>t.set(e[0],e[1],e[2]),gf=new Yt,_f=new G,vf=new G,yf=new G;function bf(e,t,n=0,r=0,i=new G){return hf(e.point(t,n,r),i)}function xf(e,t,n=new Et){return Sf(e.at(t),n)}function Sf(e,t=new Et){return hf(e.right,vf),hf(e.up,yf),_f.set(-e.fwd[0],-e.fwd[1],-e.fwd[2]),t.setFromRotationMatrix(gf.makeBasis(vf,yf,_f))}function Cf(e,t,n=0,r=0,i=new G){return hf(e.flatPoint(t,n,r),i)}function wf(e,t,n=new Et){return n.setFromAxisAngle(Cn.DEFAULT_UP,e.at(t).yaw)}function Tf(e,t,n,r=0,i=0){return bf(t,n,r,i,e.position),xf(t,n,e.quaternion),e}function Ef(e,t,n,r=0,i=0,a=0){return Cf(t,n,r,i,e.position),wf(t,n,e.quaternion),a&&e.rotateY(a),e}function Df(e,t,n,r,i,a=`road`,o=1){let s=[];for(let e=t;e<n;e+=o)s.push(e);s.push(n);let c=typeof r==`function`?r:()=>r,l=c(t),u=l.length,d=new Float32Array(s.length*u*3),f=new Float32Array(s.length*u*2),p=[0];for(let e=1;e<u;e++)p.push(p[e-1]+Math.hypot(l[e][0]-l[e-1][0],l[e][1]-l[e-1][1]));let m=new G;s.forEach((t,n)=>{c(t).forEach(([r,i],o)=>{a===`road`?bf(e,t,r,i,m):Cf(e,t,r,i,m),d.set([m.x,m.y,m.z],(n*u+o)*3),f.set([p[o]+l[0][0],t],(n*u+o)*2)})});let h=[];for(let e=0;e<s.length-1;e++)for(let t=0;t<u-1;t++){let n=e*u+t,r=n+1,i=n+u,a=i+1;h.push(n,r,i,r,a,i)}let g=new Er;g.setAttribute(`position`,new dr(d,3)),g.setAttribute(`uv`,new dr(f,2)),g.setIndex(h),g.computeVertexNormals();let _=new Xr(g,i);return _.receiveShadow=!0,_}function Of(t,n,r){return t.wrapS=t.wrapT=e,t.repeat.set(1/n,1/r),t}var kf=class{mesh;uniforms={top:{value:new J},bottom:{value:new J},sun:{value:new J},sunDir:{value:new G(.35,.18,-1).normalize()}};constructor(e){this.mesh=new Xr(new Ga(700,24,12),new to({uniforms:this.uniforms,side:1,depthWrite:!1,fog:!1,vertexShader:`
          varying vec3 vDir;
          void main() {
            vDir = normalize(position);
            gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
          }`,fragmentShader:`
          uniform vec3 top, bottom, sun, sunDir;
          varying vec3 vDir;
          void main() {
            float h = clamp(vDir.y * 1.6 + 0.25, 0.0, 1.0);
            vec3 col = mix(bottom, top, h);
            float d = max(dot(vDir, sunDir), 0.0);
            col += sun * (pow(d, 400.0) * 1.2 + pow(d, 12.0) * 0.35);
            gl_FragColor = vec4(col, 1.0);
          }`})),this.mesh.renderOrder=-1,e.add(this.mesh)}update(e,t){this.mesh.position.copy(e.position),this.uniforms.top.value.setHex(t.skyTop),this.uniforms.bottom.value.setHex(t.skyBottom),this.uniforms.sun.value.setHex(t.sun)}},Af=new J,jf=new J,Mf=(e,t,n)=>Af.setHex(e).lerp(jf.setHex(t),n).getHex();function Nf(e){let t=Ed(e),n=wd[t],r=wd[t-1],i=r?Tt.smoothstep(e,n.start-30,n.start+30):1,a=wd[t+1];return a&&e>n.end-30?Pf(n.look,a.look,Tt.smoothstep(e,n.end-30,n.end+30)):r?Pf(r.look,n.look,i):n.look}function Pf(e,t,n){return{skyTop:Mf(e.skyTop,t.skyTop,n),skyBottom:Mf(e.skyBottom,t.skyBottom,n),fog:Mf(e.fog,t.fog,n),fogNear:Tt.lerp(e.fogNear,t.fogNear,n),fogFar:Tt.lerp(e.fogFar,t.fogFar,n),sun:Mf(e.sun,t.sun,n),sunIntensity:Tt.lerp(e.sunIntensity,t.sunIntensity,n),ambient:Mf(e.ambient,t.ambient,n),ambientIntensity:Tt.lerp(e.ambientIntensity,t.ambientIntensity,n)}}function Ff(e,t){for(let n of e){if(t<=n.s0-30||t>=n.s1+30)continue;let e=Math.min(1,Math.min(t-(n.s0-30),n.s1+30-t)/30);return 1+(n.scale-1)*(e*e*(3-2*e))}return 1}function If(e,t){return Ff(e.wide,t)}function Lf(e,t){return Tu*If(e,t)}function Rf(e){let t=e>>>0;return()=>{t=t+1831565813>>>0;let e=t;return e=Math.imul(e^e>>>15,e|1),e^=e+Math.imul(e^e>>>7,e|61),((e^e>>>14)>>>0)/4294967296}}var zf=[15222106,4161504,16765503,3912307,15921906,9329622,16747546],Bf=90,Vf=45,Hf=180;function Uf(e=1){let t=Rf(e),n=e=>e[Math.floor(t()*e.length)],r=(e,n)=>e+t()*(n-e),i=()=>n([-2.8,-1.4,0,1.4,2.8]),a=()=>{let e=t();return e<.24?`cereal`:e<.44?`tp`:e<.64?`eggs`:e<.84?`watermelon`:`turkey`},o=[],s=[],c=[],l=[],u=0,d=[],f=e=>Tu*Ff(d,e),p=(e,t,n=.35)=>{let r=Math.max(.4,f(e)-n);return Math.max(-r,Math.min(r,t))},m=e=>o.push({id:u++,...e,x:e.vx||e.halfX>3?e.x:p(e.s,e.x,e.halfX)}),h=(e,t,n=a(),r=0)=>s.push({id:u++,item:n,s:e,x:p(e,t,.8),y:r,taken:!1}),{segments:g,loops:_,kickers:v}=Gf(t),y=new hd(g),b=Eu-40,x=wd.find(e=>e.key===`market`),S=[],C=(e,t)=>S.push([e,t]),w=(e,t)=>S.some(([n,r])=>e<r&&t>n);for(let[e,t]of _){C(e-40,t+12),m({kind:`boost`,s:e-28,x:0,halfX:Tu+1,halfS:1.2});for(let n=1;n<6;n++)h(e+(t-e)*n/6,0,a(),0)}for(let e of v){c.push({s:e,len:8,h:2.2}),C(e-12,e+75);for(let t=0;t<3;t++)h(e+18+t*4,(t-1)*1.6,a(),3+(t===1?.6:0))}c.push({s:b,len:10,h:3.2,finale:!0}),C(b-30,Eu+200);let T=[x.start+6,x.end-30];for(let e of T)m({kind:`overhead`,frame:!0,s:e,x:0,halfX:Tu+2,halfS:.6,h:10}),C(e-10,e+12);let E=[`Doris's Bus Stop`,`Self-Checkout`,`Mrs. Chen's Tea Shop`,`Foreman Frank's Trailer`];wd.slice(0,4).forEach((e,n)=>{let r=e.key===`market`?e.end-48:e.end-22,i=t()<.5?-1:1;l.push({s:r,x:i*2.4,name:E[n]}),C(r-30,r+10)});let D=(e,t,r)=>{for(let i of t){let t=[];for(let n=Math.max(e.start,40);n+i<Math.min(e.end,b);n+=10)w(n-30,n+i+30)||d.some(e=>n-30<e.s1+30&&n+i+30>e.s0-30)||t.push(n);if(!t.length)continue;let a=n(t);d.push({s0:a,s1:a+i,scale:r});return}};for(let e of wd)e.key!==`market`&&(e.start>=640&&D(e,[80,50],.62),D(e,[110,70],1.7));let O={line:e=>{let n=i(),r=3+Math.floor(t()*3);for(let t=0;t<r;t++)h(e+t*6,n);return r*6+8},zigzag:e=>{for(let t=0;t<5;t++)h(e+t*8,t%2?2.4:-2.4);return 48},bonanza:e=>{for(let n=0;n<5;n++)for(let r of[-2.8,0,2.8])t()<.8&&h(e+n*6,r+(n%2?.7:-.7));return 38},cones:(e,n)=>{let r=3+Math.floor(n*3);for(let n=0;n<r;n++){let r=e+n*20,i=f(r),a=(n%2?1:-1)*Math.min(1.6,i-1.4);for(let e=-i+.4;e<=i-.4;e+=1.2)Math.abs(e-a)>1.3&&m({kind:`cone`,s:r,x:e,halfX:.3,halfS:.3});t()<.7&&h(r,a)}return r*20+12},cans:e=>{for(let t=0;t<3;t++){let r=n([-2.4,0,2.4]);m({kind:`cans`,s:e+t*10,x:r,halfX:.6,halfS:.5}),h(e+t*10,r>0?r-2.4:r+2.4)}return 36},potholes:(e,t)=>{let n=2+Math.floor(t*3);for(let t=0;t<n;t++)m({kind:`pothole`,s:e+t*r(7,11),x:r(-3.4,3.4),halfX:.75,halfS:.6});return h(e+n*5,i()),n*10+10},bump:e=>(m({kind:`bump`,s:e+10,x:0,halfX:Tu+1,halfS:.4}),h(e+22,i()),34),birds:e=>{let t=i();return m({kind:`pigeons`,s:e+6,x:t,halfX:1.4,halfS:1.2}),h(e+6,t>0?t-2.4:t+2.4),22},car:e=>{if(f(e+14)<3.57)return 20;let r=t()<.5;return m({kind:`car`,s:e+14,x:r?-8:8,vx:r?4:-4,halfX:2.1,halfS:1,color:n(zf)}),h(e+14,r?1.4:-1.4,n([`eggs`,`turkey`])),38},parked:e=>{let r=t()<.5?-1:1;for(let t=0;t<2;t++)m({kind:`parked`,s:e+t*7,x:r*3.3,halfX:1,halfS:2.1,color:n(zf)});return h(e+3.5,r*1.1),24},roadblock:(e,n)=>{if(f(e)>4.83||f(e+Vf-10*n)>4.83)return 20;let r=Vf-10*n,i=t()<.5?-1:1;for(let t=0;t<2;t++){let n=e+t*r,a=f(n),o=i*(a-1.5);for(let e=-a+.5;e<=a-.5;e+=1.1)Math.abs(e-o)>1.9&&m({kind:`barricade`,s:n,x:e,halfX:.58,halfS:.35});h(n,o),h(n+16,-i*1.2),i=-i}return 1*r+26},overhead:e=>{let n=e-k.s<Hf?k.side:t()<.5?-1:1;k={s:e+10,side:n};let i=r(4.5,7);return m({kind:`overhead`,s:e+10,x:n*1.6,halfX:3.4,halfS:.4,h:i}),h(e+4,-n*2.6),h(e+16,-n*2.6),26}},k={s:-1/0,side:1},A=45;for(let e=0;e<3;e++)h(A+e*8,0,[`watermelon`,`tp`,`cereal`][e]);for(A+=40;A<b-40;){let e=A/b,n={...Td(A).weights};A+10-k.s<Bf&&delete n.overhead;let i=Object.keys(n),a=t()*i.reduce((e,t)=>e+(n[t]??0),0),c=0;for(;(a-=n[i[c]]??0)>0;)c++;let l={obstacles:o.length,pickups:s.length,id:u,lastOverhead:k},d=O[i[c]](A,e);if(w(A,A+d)){o.length=l.obstacles,s.length=l.pickups,k=l.lastOverhead,A=S.filter(([e,t])=>A<t&&A+d>e).reduce((e,[,t])=>Math.max(e,t),A+10)+2;continue}A+=d+r(2,6)*(1-.6*e)}o.sort((e,t)=>e.s-t.s);let j=o.filter(e=>e.kind!==`bump`&&e.kind!==`boost`&&e.kind!==`overhead`&&e.kind!==`pigeons`&&!e.vx);for(let e=0;e<j.length;){let t=[j[e]],n=e+1;for(;n<j.length&&j[n].s-j[e].s<2.5;)t.push(j[n++]);let r=f(j[e].s);for(let e=0;e<12;e++){let e=t.map(e=>[e.x-e.halfX-.6,e.x+e.halfX+.6]).sort((e,t)=>e[0]-t[0]),n=-r,i=0;for(let[t,a]of[...e,[r,r]])i=Math.max(i,t-n),n=Math.max(n,a);if(i>=1.9)break;let a=t.reduce((e,t)=>Math.abs(t.x)<Math.abs(e.x)?t:e);if(t.splice(t.indexOf(a),1),o.splice(o.indexOf(a),1),!t.length)break}e=n}return s.sort((e,t)=>e.s-t.s),{seed:e,length:Eu,finishS:b+10,path:y,obstacles:o,pickups:s,ramps:c,stops:l,wide:d}}function Wf(e,t){for(let n of e.ramps)if(t>=n.s&&t<=n.s+n.len)return n.h*(t-n.s)/n.len;return 0}function Gf(e){let t=[],n=[],r=[],i=0,a=()=>e()<.5?-1:1,o=e=>{let r=e.kind===`loop`?2*Math.PI*e.radius:e.len;e.kind===`loop`&&n.push([i,i+r]),t.push(e),i+=r},s=(e,t)=>o({kind:`straight`,len:Math.max(1,e-i),pitch:t}),c=Math.PI/180,l=a();return o({kind:`straight`,len:40,pitch:-.08}),o({kind:`curve`,len:70,turn:l*45*c,pitch:-.1}),o({kind:`roller`,len:60,pitch:-.08,bumps:2,height:2.2}),o({kind:`curve`,len:50,turn:-l*75*c,pitch:-.14}),o({kind:`curve`,len:50,turn:l*75*c,pitch:-.14}),o({kind:`straight`,len:25,pitch:-.3}),s(320,-.06),l=a(),o({kind:`straight`,len:70,pitch:-.03}),o({kind:`curve`,len:45,turn:l*90*c,pitch:-.03,bank:l*.18}),o({kind:`straight`,len:55,pitch:-.03}),o({kind:`curve`,len:45,turn:-l*90*c,pitch:-.03,bank:-l*.18}),s(640,-.03),r.push(624),l=a(),o({kind:`straight`,len:30,pitch:-.1}),o({kind:`curve`,len:60,turn:l*55*c,pitch:-.12}),o({kind:`curve`,len:60,turn:-l*55*c,pitch:-.12}),o({kind:`straight`,len:30,pitch:-.32}),o({kind:`straight`,len:25,pitch:-.08}),o({kind:`curve`,len:55,turn:l*40*c,pitch:-.08}),s(960,-.06),l=a(),o({kind:`straight`,len:30,pitch:-.1}),o({kind:`straight`,len:30,pitch:-.35}),o({kind:`straight`,len:45,pitch:-.04}),r.push(i-30),o({kind:`straight`,len:45,pitch:-.02}),o({kind:`loop`,radius:16,shift:l*11}),o({kind:`curve`,len:50,turn:-l*50*c,pitch:-.06}),s(1280,-.06),l=a(),o({kind:`straight`,len:25,pitch:-.05}),o({kind:`roller`,len:75,pitch:-.04,bumps:3,height:2.6}),o({kind:`straight`,len:35,pitch:-.02}),o({kind:`loop`,radius:16,shift:l*11}),o({kind:`curve`,len:70,turn:l*70*c,pitch:-.05}),s(1600,-.04),o({kind:`straight`,len:260,pitch:-.02}),{segments:t,loops:n,kickers:r}}var Kf=5,qf=()=>Kf;function Jf(e,t,n){let r=[],i=t,a=e.at(t).inLoop;for(let o=t;o<=n;o+=.5){let t=e.at(o).inLoop;t!==a&&(r.push({a:i,b:o,loop:a}),i=o,a=t)}return r.push({a:i,b:n,loop:a}),r.filter(e=>e.b-e.a>.4)}function Yf(e,t,n,r){let i=e.at(t).curve;return i>0&&n<0||i<0&&n>0?Math.min(r,.8/Math.abs(i)):r}var Xf=(e,t)=>-.3-qf(t)*Math.abs(Math.sin(e.at(t).bank)),Zf=(e,t,n)=>Math.abs(e.at(t).curve*n)<.55||Math.sign(e.at(t).curve)===-Math.sign(n);function Qf(e,t,n){return Of(e,t,n),e.offset.x=.5,e}var $f={hill:{tex:()=>Qf(jd.road(10),10,10),skirt:9078136,ground:12170150},market:{tex:()=>Of(jd.tile(2),2.5,2.5),skirt:12173254,ground:()=>Of(jd.tile(2),2.5,2.5)},lanterns:{tex:()=>Of(jd.brick(2),2.5,2.5),skirt:5907488,ground:7219750},roadwork:{tex:()=>Of(jd.dirt(6),5,6),skirt:8017460,ground:10254930},boardwalk:{tex:()=>Of(jd.planks(2),3,2.5),skirt:7031338,ground:()=>Of(jd.sand(),8,8)}};function ep(e,t){qf=e=>Kf*If(t,e);let n=t.path,r=Rf(t.seed+99),i={doors:[],friends:[]},a=t.finishS+50;for(let t of wd){let o=Math.max(0,t.start),s=Math.min(n.length-1,t.end,a);s<=o||(tp(e,n,t,o,s),op[t.key](e,n,t,o,s,r,i))}for(let r of t.ramps)e.add(Tf(Jd(r.len,r.h,r.finale?10:9.6),n,r.s));let o=[[8374441,4161504],[15222106,3817032],[16765503,12986943],[16747546,2761504]];t.stops.forEach((t,r)=>{let a=Math.sign(t.x);e.add(Tf(mf(10,12,a),n,t.s));let[s,c]=o[r%o.length],l=Ef(ff(s,c),n,t.s+1,a*(qf(t.s)+1.2),.2,a>0?Math.PI/2:-Math.PI/2);e.add(l),i.friends.push({obj:l,s:t.s})}),e.add(Ef(Yd(),n,t.finishS+62,0,0));for(let[r,i]of[[-9,55],[10,58],[-14,40],[16,30]])e.add(Ef(lf(),n,t.finishS+i,r,-.5));sp(e,n);let s=wd[4],c=1/0;for(let e=s.start;e<n.length;e+=5)c=Math.min(c,n.heightAt(e));let l=new Xr(new Va(5e3,5e3),Z(3117008));l.rotation.x=-Math.PI/2;let u=Cf(n,(s.start+t.finishS)/2);return l.position.set(u.x,c-6,u.z),e.add(l),i}function tp(e,t,n,r,i){let a=$f[n.key],o=Z(16777215,{map:a.tex(),side:2}),s=Z(a.skirt,{side:2}),c=typeof a.ground==`number`?Z(a.ground):Z(16777215,{map:a.ground()});for(let n of Jf(t,r,i)){if(n.loop){e.add(Df(t,n.a,n.b,e=>[[-qf(e),0],[qf(e),0]],o,`road`,.5)),e.add(Df(t,n.a,n.b,e=>[[qf(e),-.4],[-qf(e),-.4]],s,`road`,.5));let r=Z(15222106,{side:2});for(let i of[-1,1])e.add(Df(t,n.a,n.b,e=>[[i*qf(e),-.4],[i*qf(e),.7]],r,`road`,.5));continue}e.add(Df(t,n.a,n.b,e=>[[-qf(e),0],[qf(e),0]],o)),e.add(Df(t,n.a,n.b,e=>[[-qf(e),-6],[-qf(e),0]],s)),e.add(Df(t,n.a,n.b,e=>[[qf(e),0],[qf(e),-6]],s)),e.add(Df(t,n.a,n.b,e=>{let n=Xf(t,e);return[[-Yf(t,e,-1,90),n],[Yf(t,e,1,90),n]]},c,`flat`,2))}}function np(e,t,n,r,i){for(let a of Jf(t,n,r))a.loop||(e.add(Df(t,a.a,a.b,e=>[[-qf(e)-3,-2],[-qf(e)-3,.25],[-qf(e),.25],[-qf(e),0]],i)),e.add(Df(t,a.a,a.b,e=>[[qf(e),0],[qf(e),.25],[qf(e)+3,.25],[qf(e)+3,-2]],i)))}function rp(e,t,n,r,i=`flat`,a){if(!r.length)return;let o=new ci(a??new vi(1,1,1),n,r.length),s=new Yt,c=new Et,l=new G,u=new G,d=new J;r.forEach((e,n)=>{i===`road`?(bf(t,e.s,e.x,e.y,l),xf(t,e.s,c)):(Cf(t,e.s,e.x,e.y,l),wf(t,e.s,c)),o.setMatrixAt(n,s.compose(l,c,u.set(e.w,e.h,e.d))),e.color!==void 0&&o.setColorAt(n,d.setHex(e.color))}),e.add(o)}function ip(e,t,n,r,i,a,o){let s=[];for(let e of[-1,1])for(let o=n;o<r;){let n=7+i()*5,r=8+i()*4,c=7+i()*12,l=o+n/2,u=e*(qf(l)+3.2+r/2);Zf(t,l,u+e*r)&&!t.at(l).inLoop&&s.push({s:l,x:u,w:n,d:r,h:c,base:Xf(t,l)-.5,color:a[Math.floor(i()*a.length)]}),o+=n+.4}return rp(e,t,new ro({map:jd.windows()}),s.map(e=>({s:e.s,x:e.x,y:e.base+e.h/2,w:e.d,h:e.h,d:e.w,color:e.color}))),rp(e,t,Z(o),s.map(e=>({s:e.s,x:e.x,y:e.base+e.h+.25,w:e.d+.5,h:.5,d:e.w+.3}))),s}function ap(e,t,n,r){let i=[],a=[],o=[],s=[];for(let e=n+10;e<r;e+=24)if(!t.at(e).inLoop)for(let t of[-1,1]){let n=t*(qf(e)+.8);i.push({s:e,x:n,y:2.5,w:.16,h:4.5,d:.16}),a.push({s:e,x:n,y:4.8,w:.5,h:.5,d:.5}),o.push({s:e+12,x:n,y:1.1,w:.3,h:1.6,d:.3}),s.push({s:e+12,x:n,y:2.7,w:2,h:2.2,d:2})}rp(e,t,Z(3817032),i,`road`),rp(e,t,Z(16773808,{emissive:8415776}),a,`road`),rp(e,t,Z(8016432),o,`road`),rp(e,t,Z(5221975,{flatShading:!0}),s,`road`,new Ba(.6,0))}var op={hill:(e,t,n,r,i,a)=>{np(e,t,r,i,Z(16777215,{map:Of(jd.sidewalk(3),3,3)})),ip(e,t,r,i,a,[16238279,16507809,12182470,12244978,15124978,16767153,15921897,13234415],16777215),ap(e,t,r,i)},market:(e,t,n,r,i,a,o)=>{let s=r+6,c=n.end-30,l=Z(14935786,{side:2});for(let n of[-1,1])e.add(Df(t,s,c,e=>[[n*Yf(t,e,n,22),Xf(t,e)],[n*Yf(t,e,n,22),18]],l,`flat`,2));e.add(Df(t,s,c,e=>[[Yf(t,e,1,22),18],[-Yf(t,e,-1,22),18]],Z(14278114,{side:2}),`flat`,2));let u=Z(16777215,{map:jd.shelves()}),d=Z(14039630),f=[];for(let e of[Kf+1.6,Kf+7,Kf+12.4])for(let n=s+8;n<c-8;n+=10)for(let r of[-1,1])Zf(t,n+4,r*(e+1))&&f.push({s:n+4,x:r*e,y:Xf(t,n+4)+2.9,w:1.8,h:5.2,d:8});rp(e,t,[u,u,d,d,d,d],f);let p=[];for(let e=s+6;e<c;e+=9)for(let n of[-12,0,12])Zf(t,e,n)&&p.push({s:e,x:n,y:17.8,w:6,h:.2,d:.8});rp(e,t,Z(16777215,{emissive:16774872}),p);for(let[n,r]of[[s,!1],[c,!0]]){let i=cf(12,10,r);e.add(Tf(i.group,t,n)),o.doors.push({doors:i,s:n})}},lanterns:(e,t,n,r,i,a)=>{np(e,t,r,i,Z(8007722));let o=ip(e,t,r,i,a,[12986943,2067056,14721072,12076378,2911887],3809050);rp(e,t,Z(2837050),o.map(e=>({s:e.s,x:e.x,y:e.base+e.h+1.4,w:e.d*1.15,h:2.4,d:e.w*1.15})),`flat`,new xi(.72,1,4).rotateY(Math.PI/4));let s=[],c=[],l=[];for(let e=r+4;e<i;e+=3.2)if(!t.at(e).inLoop)for(let t of[-1,1])s.push({s:e,x:t*(qf(e)+3.1),y:4.4+Math.sin(e)*.3,w:.55,h:.7,d:.55}),Math.floor(e/3.2)%4==0&&(c.push({s:e,x:t*(qf(e)+1.9),y:2.6,w:2.2,h:.15,d:3,color:[15222106,16765503,3912307][Math.floor(e)%3]}),l.push({s:e,x:t*(qf(e)+.9),y:1.4,w:.1,h:2.4,d:.1}));rp(e,t,Z(15222106,{emissive:12591146}),s,`road`),rp(e,t,Z(16777215),c,`road`),rp(e,t,Z(3809050),l,`road`)},roadwork:(e,t,n,r,i,a)=>{let o=[];for(let e=r;e<i;e+=2.4)if(!t.at(e).inLoop)for(let t of[-1,1])o.push({s:e,x:t*(qf(e)+.4),y:.45,w:.3,h:.9,d:2,color:Math.floor(e/2.4)%2?16742938:16777215});rp(e,t,Z(16777215),o,`road`);let s=[],c=[];for(let e of[-1,1])for(let n=r+5;n<i-10;n+=22+a()*8){let r=e*(qf(n)+14);if(!Zf(t,n+7,r+e*7)||t.at(n+7).inLoop)continue;let i=3+Math.floor(a()*4),o=Xf(t,n+7);for(let e=1;e<=i;e++)s.push({s:n+7,x:r,y:o+e*3.4,w:12,h:.4,d:14});for(let e of[-5.5,5.5])for(let t of[.5,13.5])c.push({s:n+t,x:r+e,y:o+i*3.4/2,w:.5,h:i*3.4,d:.5})}rp(e,t,Z(12170410),s),rp(e,t,Z(10328206),c);for(let[n,i,a]of[[60,-30,.6],[200,34,2.6]])e.add(Ef(df(),t,r+n,i,Xf(t,r+n),a))},boardwalk:(e,t,n,r,i,a)=>{let o=[];for(let e=r;e<i;e+=2)if(!t.at(e).inLoop)for(let t of[-1,1])o.push({s:e,x:t*(qf(e)+.2),y:.5,w:.15,h:1,d:.15});rp(e,t,Z(15918800),o,`road`);let s=Z(15918800,{side:2});for(let n of Jf(t,r,i))if(!n.loop)for(let r of[-1,1])e.add(Df(t,n.a,n.b,e=>[[r*(qf(e)+.2),.95],[r*(qf(e)+.2),1.1]],s));let c=[15222106,16765503,4161504,3912307],l=0;for(let n=r+8;n<i;n+=16)if(!t.at(n).inLoop)for(let r of[-1,1]){let i=r*(qf(n)+3+a()*4);Zf(t,n,i)&&e.add(Ef(lf(),t,n,i,Xf(t,n)));let o=r*(qf(n)+9+a()*10);Zf(t,n+6,o)&&e.add(Ef(uf(c[l++%c.length]),t,n+6,o,Xf(t,n+6)))}}};function sp(e,t){let n=[],r=new G;for(let e of Jf(t,0,t.length-1)){if(!e.loop)continue;let i=t.heightAt(e.a)-.5;for(let a=e.a;a<e.b;a+=6)for(let e of[-qf(a)-.3,qf(a)+.3]){bf(t,a,e,-.4,r);let o=r.y-i;o<1||n.push(new Yt().compose(new G(r.x,i+o/2,r.z),new Et,new G(1,o,1)))}}if(!n.length)return;let i=new ci(new bi(.1,.1,1,6),Z(14707226),n.length);n.forEach((e,t)=>i.setMatrixAt(t,e)),e.add(i)}var cp={market:[`AISLE 7 · CEREAL`,`AISLE 3 · EGGS`,`BAKERY`,`FROZEN FOODS`,`PRODUCE`,`SNACKS`],lanterns:[`NIGHT MARKET`,`DUMPLINGS`,`LUCKY 88`,`TEA HOUSE`],boardwalk:[`SURF CONTEST`,`ICE CREAM`,`PIER 39`],hill:[`GARAGE SALE`],roadwork:[``]},lp=new G,up=new G,dp=new Et,fp=new on(0,0,0,`YXZ`),pp=class{renderer;sim;scene=new Mn;camera=new zo(70,1,.1,1200);sun=new Ho(16777215,2.6);ambient=new Do(16777215,9272168,1.6);sky;world;fx;cartRoot=new q;grandma;stackMeshes=new Map;pickups=new Map;obstacles=new Map;flying=[];deliveries=[];floor;shake=0;camPos=new G;camLook=new G;camFwd=new G(0,0,-1);camUp=new G(0,1,0);cartQuat=new Et;camX=0;yaw=0;patAnim=0;fovKick=0;sideShot=0;grandmaOnCart=!0;time=0;curveLean=0;constructor(e,t){this.renderer=e,this.sim=t,this.fx=new Od(this.scene),this.fx.groundAt=e=>this.groundAt(e),this.sky=new kf(this.scene);let n=t.track.path.frames;this.floor=new Float32Array(n.length);let r=0;n.forEach((e,t)=>{e.inLoop||(r=e.pos[1]),this.floor[t]=e.inLoop?r:e.pos[1]}),this.build()}get path(){return this.sim.track.path}build(){let e=this.scene;e.background=new J(10475775),e.fog=new jn(12576511,70,330),e.add(this.ambient),this.sun.castShadow=!0,this.sun.shadow.mapSize.set(1024,1024);let t=this.sun.shadow.camera;t.left=t.bottom=-10,t.right=t.top=10,t.near=1,t.far=80,e.add(this.sun,this.sun.target),this.world=ep(e,this.sim.track),this.cartRoot.add(Vd()),this.grandma=Hd(),this.grandma.root.position.set(0,Rd+.02,Bd),this.cartRoot.add(this.grandma.root),e.add(this.cartRoot),xf(this.path,0,this.cartQuat),this.place(0);let n=this.path.at(0);this.camFwd.set(...n.fwd),this.camUp.set(...n.up);let r=this.cameraTarget();this.camPos.copy(r.pos),this.camLook.copy(r.look)}resize(e,t){this.renderer.setSize(e,t,!1),this.camera.aspect=e/t,this.camera.updateProjectionMatrix()}sAt(e){let t=this.path.at(this.sim.s);return up.copy(e).sub(this.cartRoot.position),Tt.clamp(this.sim.s+up.x*t.fwd[0]+up.y*t.fwd[1]+up.z*t.fwd[2],0,this.path.length-1)}groundAt(e){return this.floor[Math.round(this.sAt(e)/.5)]??-1/0}cartVelocity(e=new G){let t=this.path.at(this.sim.s);return e.set(t.fwd[0]*this.sim.v+t.right[0]*this.sim.vx,t.fwd[1]*this.sim.v+this.sim.vy*+!!this.sim.airborne,t.fwd[2]*this.sim.v+t.right[2]*this.sim.vx)}handle(e){let t=this.sim,n=this.path;switch(e.type){case`pickup`:{let t=Ld(e.pickup.item);t.userData.key=e.pickup.item,this.pickups.get(e.pickup.id)?.removeFromParent(),this.pickups.delete(e.pickup.id),this.cartRoot.updateMatrixWorld();let r=this.cartRoot.worldToLocal(bf(n,e.pickup.s,e.pickup.x,e.pickup.y+.9));this.cartRoot.add(t),this.stackMeshes.set(e.uid,{obj:t,from:r,t:0}),this.fx.burst(this.cartRoot.localToWorld(lp.set(0,2,0)),10,{colors:[16765503,16777215],speed:4,size:.1,life:.5,gravity:4});break}case`lost`:this.throwItems(e.lost.items.map(e=>e.uid),e.lost.rollDir,e.lost.pitchDir,!!e.lost.swept),this.shake=Math.max(this.shake,.25);break;case`cashout`:this.deliver(e.uids,e.stop?.s??null);break;case`hit`:{let r=e.obstacle,i=bf(n,t.s,t.x,.3);if(r.kind===`cone`){let e=this.obstacles.get(r.id);if(e){this.obstacles.delete(r.id);let t=this.cartVelocity().multiplyScalar(.9).add(lp.set(0,6,0));this.flying.push({obj:e,vel:t,spin:new G(8,3,6),radius:.3,bounces:0})}this.fx.burst(i,8,{colors:[16742938,16777215],speed:5})}else r.kind===`pothole`||r.kind===`bump`?(this.fx.burst(i,14,{colors:[9080732,6053995],speed:4,size:.14}),this.fx.burst(i,6,{colors:[16769126],speed:7,size:.05,life:.3}),this.shake=Math.max(this.shake,.18*(.5+e.strength))):r.kind===`cans`?(this.obstacles.get(r.id)?.removeFromParent(),this.obstacles.delete(r.id),this.fx.burst(bf(n,r.s,r.x,.5),30,{colors:[14039630,16777215,13226458],speed:7,size:.16,up:.6}),this.shake=Math.max(this.shake,.2)):r.kind===`overhead`?this.shake=Math.max(this.shake,.3):r.kind===`pigeons`&&this.fx.burst(bf(n,r.s,r.x,.6),24,{colors:[16777215,12106950],speed:5,size:.1,gravity:1.5,life:1.4});break}case`boost`:this.fovKick=12,this.fx.burst(bf(n,t.s,t.x,.3),24,{colors:[16765503,16777215],speed:8,size:.08,life:.4,up:.1}),this.shake=Math.max(this.shake,.15);break;case`land`:this.fx.burst(bf(n,t.s,t.x,.1),16,{colors:[14275523,11840924],speed:5,size:.15,up:.2}),this.shake=Math.max(this.shake,Math.min(.5,e.strength*.03));break;case`launch`:e.ramp?.finale&&(this.sideShot=2.2);break;case`pat`:this.patAnim=.45;break;case`nearMiss`:this.fx.burst(bf(n,t.s,t.x,.8),10,{colors:[16769126,16777215],speed:6,size:.06,life:.3});break;case`curb`:this.fx.burst(bf(n,t.s,t.x+Math.sign(t.x)*.5,.1),8,{colors:[16769126],speed:6,size:.05,life:.25});break;case`wipeout`:this.shake=.8,this.fx.burst(bf(n,t.s+1,t.x,.8),30,{colors:[16769126,16747546,16777215],speed:9,size:.1,life:.5}),this.launchGrandma();break;case`finish`:this.fx.burst(bf(n,t.s,t.x,3),120,{colors:[15222106,16765503,4161504,3912307,16777215,12098528],speed:9,size:.14,life:2.4,gravity:5,up:1.2})}}deliver(e,t){let n=t===null?null:this.world.friends.find(e=>e.s===t),r=n?n.obj.position.clone().add(lp.set(0,1.4,0)):Cf(this.path,this.sim.track.finishS+62,0,1.2);this.cartRoot.updateMatrixWorld(),e.forEach((t,n)=>{let i=this.stackMeshes.get(t);if(!i)return;this.stackMeshes.delete(t);let a=i.obj.getWorldPosition(new G);i.obj.getWorldQuaternion(i.obj.quaternion),this.scene.add(i.obj),i.obj.position.copy(a),this.deliveries.push({obj:i.obj,from:a,to:r.clone(),t:-(e.length-1-n)*.05})}),this.fx.burst(r,40,{colors:[16765503,3912307,16777215],speed:7,size:.12,life:1.2,up:1})}throwItems(e,t,n,r){this.cartRoot.updateMatrixWorld();let i=this.path.at(this.sim.s),a=new G(...i.right),o=new G(...i.fwd),s=new G(...i.up),c=this.cartVelocity();e.forEach((e,i)=>{let l=this.stackMeshes.get(e);if(!l)return;this.stackMeshes.delete(e);let u=l.obj;u.getWorldPosition(lp),u.getWorldQuaternion(u.quaternion),this.scene.add(u),u.position.copy(lp);let d=r?c.clone().multiplyScalar(.1).addScaledVector(a,(Math.random()-.5)*3).addScaledVector(s,1+Math.random()*2):c.clone().multiplyScalar(.8+Math.random()*.15).addScaledVector(a,t*(2.5+i*.6+Math.random()*1.5)).addScaledVector(s,2+i*.35+Math.random()).addScaledVector(o,n*2);this.flying.push({obj:u,key:u.userData.key,vel:d,spin:r?new G(6+Math.random()*6,(Math.random()-.5)*4,(Math.random()-.5)*4):new G((Math.random()-.5)*10,(Math.random()-.5)*6,-t*(4+Math.random()*5)),radius:.25,bounces:0})})}launchGrandma(){if(!this.grandmaOnCart)return;this.grandmaOnCart=!1;let e=this.grandma.root;this.cartRoot.updateMatrixWorld(),e.getWorldPosition(lp),e.getWorldQuaternion(e.quaternion),this.scene.add(e),e.position.copy(lp);let t=this.cartVelocity().multiplyScalar(.9).add(lp.set((Math.random()-.5)*3,7.5,0));this.flying.push({obj:e,vel:t,spin:new G(-6,1.5,2),radius:.4,bounces:0,grandma:!0}),this.grandma.armL.rotation.x=this.grandma.armR.rotation.x=-2.6}update(e){this.time+=e,this.applyLook(),this.animateDoors(),this.animateFriends(),this.place(e),this.syncStack(e),this.syncTrack(e),this.updateFlying(e),this.updateDeliveries(e),this.fx.update(e),this.updateCamera(e)}applyLook(){let e=Nf(this.sim.s),t=this.scene.fog;t.color.setHex(e.fog),t.near=e.fogNear,t.far=e.fogFar,this.sun.color.setHex(e.sun),this.sun.intensity=e.sunIntensity,this.ambient.color.setHex(e.ambient),this.ambient.intensity=e.ambientIntensity,this.sky.update(this.camera,e)}animateDoors(){for(let{doors:e,s:t}of this.world.doors){let n=Tt.smoothstep(40-(t-this.sim.s),0,30);e.left.position.x=-3-n*6,e.right.position.x=3+n*6}}animateFriends(){for(let{obj:e,s:t}of this.world.friends){let n=t-this.sim.s<80&&t-this.sim.s>-10;e.userData.arms.forEach((e,t)=>e.rotation.x=n?-2.4+Math.sin(this.time*12+t*3)*.5:-1.2)}}place(e){let t=this.sim,n=this.path;t.airborne?(bf(n,t.s,t.x,0,this.cartRoot.position),this.cartRoot.position.y+=t.y):bf(n,t.s,t.x,t.y,this.cartRoot.position),xf(n,t.s,dp),this.cartQuat.slerp(dp,Math.min(1,e*18||1));let r=0;if(t.airborne)r=Math.atan2(t.vy,Math.max(t.v,1))*.5-n.at(t.s).pitch*.5;else if(t.y>.01){let e=t.track.ramps.find(e=>t.s>=e.s&&t.s<=e.s+e.len);e&&(r=Math.atan(e.h/e.len))}let i=-Math.atan2(t.vx,Math.max(t.v,1))*.45;this.yaw+=(i-this.yaw)*Math.min(1,e*10);let a=this.yaw,o=Tt.clamp((t.aLat+t.curvePush*.5)*.0035,-.14,.14),s=t.phase===`run`?Math.sin(this.time*38)*.004*(t.v/38):0;if(fp.set(r,a,o+s),this.cartRoot.quaternion.copy(this.cartQuat).multiply(dp.setFromEuler(fp)),this.grandmaOnCart){let r=this.grandma,i=t.v/38;r.body.rotation.z=Tt.clamp(-(t.aLat+t.curvePush)*.007,-.4,.4),r.body.rotation.x=-.05-i*.15,r.head.rotation.z=Math.sin(this.time*9)*.06*i,this.patAnim=Math.max(0,this.patAnim-e);let a=Tt.smoothstep(i,.55,.8),o=t.airborne||n.at(t.s).inLoop?Math.sin(this.time*22)*.9:0,s=.35+a*1.15+Math.abs(o)*.6;r.armL.rotation.set(-.5*(1-a)+o,0,-s),r.armR.rotation.set(-.5*(1-a)-o,0,s),this.patAnim>0&&r.armR.rotation.set(2.4+Math.sin(this.patAnim*30)*.25,0,.4)}this.cartRoot.children[0].children.forEach(n=>{n.name===`wheel`&&(n.rotation.x-=t.v*e/.1)})}syncStack(e){let t=Tt.clamp(-this.sim.curvePush*.005,-.3,.3);this.curveLean+=(t-this.curveLean)*Math.min(1,e*4);let n=Math.cos(this.curveLean),r=Math.sin(this.curveLean);for(let t of this.sim.stack.pose()){let i=this.stackMeshes.get(t.uid);if(i){if(lp.set(t.x*n+t.y*r,Rd+(t.y*n-t.x*r),zd-t.f),i.from){i.t=Math.min(1,i.t+e/.28);let n=i.t;up.lerpVectors(i.from,lp,n),up.y+=Math.sin(n*Math.PI)*1.2,i.obj.position.copy(up),i.obj.rotation.set(-t.pitch,(1-n)*6,-t.roll-this.curveLean),n>=1&&(i.from=void 0)}else i.obj.position.copy(lp),i.obj.rotation.set(-t.pitch,0,-t.roll-this.curveLean)}}}syncTrack(e){let{track:t,s:n}=this.sim,r=this.path;for(let i of t.pickups){let t=this.pickups.get(i.id);if(!(!i.taken&&i.s>n-6&&i.s<n+150)){t&&(t.removeFromParent(),this.pickups.delete(i.id));continue}if(!t){t=new q,t.add(Ld(i.item));let e=new Xr(new Ka(.55,.05,6,24),new Rr({color:16769126}));e.rotation.x=Math.PI/2,e.position.y=-.55,t.add(e),this.scene.add(t),this.pickups.set(i.id,t)}Tf(t,r,i.s,i.x,i.y+.9+Math.sin(this.time*3+i.id)*.12),t.children[0].rotation.y+=e*1.8}for(let i of t.obstacles){let t=this.obstacles.get(i.id);if(!(i.s>n-25&&i.s<n+180)){t&&(t.removeFromParent(),this.obstacles.delete(i.id));continue}if(!t){if((i.kind===`cone`||i.kind===`cans`)&&i.hit)continue;t=this.makeObstacle(i),this.scene.add(t),this.obstacles.set(i.id,t)}Tf(t,r,i.s,i.x,0),i.kind===`pigeons`&&this.animatePigeons(t,i,e)}}makeObstacle(e){let t=Td(e.s).key,n=(e,t=0)=>{let n=new q;return e.rotation.y=t,n.add(e),n};switch(e.kind){case`cone`:return t===`market`?Xd():t===`roadwork`?Zd():t===`boardwalk`?Qd():Ud();case`cans`:return $d();case`barricade`:return Zd();case`pothole`:return t===`market`?ef():t===`boardwalk`?tf():Wd();case`bump`:return Gd(e.halfX*2);case`boost`:return pf(e.halfX*2-1);case`car`:{let r=(e.vx??1)>0?0:Math.PI;return n(t===`market`?rf():t===`roadwork`?af():Kd(e.color??15222106),r)}case`parked`:return t===`market`?of():n(Kd(e.color??15222106),Math.PI/2);case`overhead`:{if(e.frame)return new q;let n=cp[t];return sf(t===`market`?`aisle`:t===`roadwork`?`beam`:t===`boardwalk`?`surf`:`banner`,e.halfX*2,e.h??5,n[e.id%n.length])}case`pigeons`:{let n=new q;for(let r=0;r<6;r++){let r=t===`boardwalk`?nf():qd();r.position.set((Math.random()-.5)*e.halfX*1.6,.14,(Math.random()-.5)*e.halfS*1.6),r.rotation.y=Math.random()*Math.PI*2,r.userData.vel=new G((Math.random()-.5)*4,5+Math.random()*3,(Math.random()-.5)*4),n.add(r)}return n}}}animatePigeons(e,t,n){let r=t.s-this.sim.s<14;for(let t of e.children){if(!r){t.position.y=.14+Math.abs(Math.sin(this.time*6+t.id))*.03;continue}t.position.addScaledVector(t.userData.vel,n);let e=Math.sin(this.time*40+t.id)*.9;t.getObjectByName(`wingL`).rotation.z=e,t.getObjectByName(`wingR`).rotation.z=-e}}updateFlying(e){this.flying=this.flying.filter(t=>{t.vel.y-=20*e,t.obj.position.addScaledVector(t.vel,e),t.obj.rotation.x+=t.spin.x*e,t.obj.rotation.y+=t.spin.y*e,t.obj.rotation.z+=t.spin.z*e;let n=this.groundAt(t.obj.position)+t.radius;if(t.obj.position.y<n){t.obj.position.y=n;let e=-t.vel.y;t.bounces===0&&e>3&&this.smash(t,e),t.bounces++,t.grandma?(t.vel.set(t.vel.x*.6,Math.max(0,e*.25),t.vel.z*.6),t.spin.multiplyScalar(.3),t.bounces>2&&t.obj.rotation.set(-Math.PI/2,t.obj.rotation.y,0)):(t.vel.set(t.vel.x*.7,e*.35,t.vel.z*.7),t.spin.multiplyScalar(.7)),(t.bounces>6||e<1&&t.bounces>1)&&(t.vel.set(0,0,0),t.spin.set(0,0,0))}let r=t.obj.position.distanceTo(this.cartRoot.position)>90&&this.sAt(t.obj.position)<this.sim.s;return r&&t.obj.removeFromParent(),!r&&t.obj.parent!==null})}updateDeliveries(e){this.deliveries=this.deliveries.filter(t=>{if(t.t+=e/.7,t.t<0)return!0;let n=Math.min(1,t.t);return t.obj.position.lerpVectors(t.from,t.to,n),t.obj.position.y+=Math.sin(n*Math.PI)*4,t.obj.rotation.y+=e*10,t.obj.scale.setScalar(1-n*.6),n>=1&&t.obj.removeFromParent(),n<1})}smash(e,t){let n=e.obj.position.clone();if(e.key===`eggs`){this.fx.burst(n,26,{colors:[16762138,16769126,16777215],speed:3+t*.3,size:.1,up:.2});let r=new Xr(new yi(.5,12),new Rr({color:16765503}));r.rotation.x=-Math.PI/2,r.position.set(n.x,this.groundAt(n)+.03,n.z),this.scene.add(r),e.obj.removeFromParent()}else e.key===`watermelon`&&t>6?(this.fx.burst(n,30,{colors:[15222106,16739197,3972421,1776678],speed:4+t*.3,size:.13,up:.3}),e.obj.removeFromParent()):this.fx.burst(n,8,{colors:[14275523],speed:3,size:.12})}cameraTarget(){let e=this.sim.stack.height,t=this.sim.airborne?this.cartRoot.position.clone():bf(this.path,this.sim.s,this.camX,this.sim.y);this.sim.airborne&&t.addScaledVector(lp.set(...this.path.at(this.sim.s).right),this.camX-this.sim.x);let n=up.crossVectors(this.camFwd,this.camUp).normalize(),r=this.path,i=[-10,0,10,25].some(e=>r.at(this.sim.s+e).inLoop),a=i?Math.min(3+e*.85,5):3+e*.85,o=i?7.5:5.6+e*.5,s=t.clone().addScaledVector(this.camFwd,-o).addScaledVector(this.camUp,a),c=t.clone().addScaledVector(this.camFwd,7).addScaledVector(this.camUp,i?1.5:.9+e*.5);if(this.sideShot>0){let r=Tt.smoothstep(Math.min(1,this.sideShot,2.2-this.sideShot+.4),0,1);s.lerp(t.clone().addScaledVector(n,7.5).addScaledVector(this.camUp,1.8+e*.4).addScaledVector(this.camFwd,-1.5),r),c.lerp(t.clone().addScaledVector(this.camFwd,3).addScaledVector(this.camUp,1+e*.4),r)}return{pos:s,look:c}}updateCamera(e){let t=this.sim;this.sideShot=Math.max(0,this.sideShot-e),this.camX+=(t.x*.6-this.camX)*(1-Math.exp(-e*4.5));let n=this.path.at(t.s+2),r=1-Math.exp(-e*6);this.camFwd.lerp(lp.set(...n.fwd),r).normalize(),lp.set(...n.up),n.inLoop||lp.lerp(Cn.DEFAULT_UP,.6).normalize(),this.camUp.lerp(lp,r).normalize();let{pos:i,look:a}=this.cameraTarget(),o=1-Math.exp(-e*(this.sideShot>0?4:9));this.camPos.lerp(i,o),this.camLook.lerp(a,o),this.shake=Math.max(0,this.shake-e*1.5);let s=this.shake*this.shake;this.camera.position.copy(this.camPos).add(lp.set((Math.random()-.5)*s,(Math.random()-.5)*s,0)),this.camera.up.copy(this.camUp),this.camera.lookAt(this.camLook);let c=this.camera.aspect<1?70:56;this.fovKick=Math.max(0,this.fovKick-e*8);let l=Math.min(c+30,c+t.v/38*12+this.fovKick);Math.abs(this.camera.fov-l)>.05&&(this.camera.fov=l,this.camera.updateProjectionMatrix());let u=this.cartRoot.position;this.sun.position.set(u.x+8,u.y+18,u.z+5),this.sun.target.position.copy(u)}render(){this.renderer.render(this.scene,this.camera)}dispose(){this.scene.traverse(e=>{(e instanceof Xr||e instanceof ci)&&e.geometry.dispose()})}},mp=1.8,hp=1,gp=class{rand;items=[];joints=[];constructor(e){this.rand=e}get height(){return this.items.reduce((e,t)=>e+kd[t.key].h,0)}get mass(){return this.items.reduce((e,t)=>e+kd[t.key].mass,0)}add(e,t=0){let n={key:e,uid:hp++,roll:0,pitch:0,vRoll:0,vPitch:t*(.5+this.rand()*.5)};return this.items.push(n),this.rebuild(),n}impulse(e,t,n=1){this.items.forEach((r,i)=>{let a=this.joints[i],o=a.cushioned?n:1,s=a.whip*o/Math.max(.35,Math.sqrt(a.lever));r.vRoll+=e*s,r.vPitch+=t*s})}pat(){for(let e of this.items)e.roll*=.5,e.pitch*=.4,e.vRoll*=.15,e.vPitch*=.15}danger(){let e=0,t=0;return this.items.forEach((n,r)=>{t+=n.roll,e=Math.max(e,Math.abs(n.roll)/this.joints[r].breakAngle,Math.abs(t)/mp)}),e}step(e,t,n){for(let r=0;r<this.items.length;r++){let i=this.items[r],a=this.joints[r],o=Nu*3/a.lever,s=2*Pu*Math.sqrt(o),c=-Iu*t*a.whip,l=-Iu*n*.5;i.vRoll+=(-o*(i.roll-c)-s*i.vRoll)*e,i.vPitch+=(-o*(i.pitch-l)-s*i.vPitch)*e,i.roll+=i.vRoll*e,i.pitch+=i.vPitch*e,Math.abs(i.pitch)>.3&&(i.pitch=Math.sign(i.pitch)*zu,i.vPitch*=-.3)}let r=0;for(let e=0;e<this.items.length;e++){let t=this.items[e];if(r+=t.roll,Math.abs(t.roll)>this.joints[e].breakAngle||Math.abs(r)>mp)return this.breakAt(e)}return null}breakAt(e){let t=this.pose().slice(e),n=this.items[e],r={items:this.items.slice(e),poses:t,rollDir:Math.sign(n.roll+n.vRoll*.1)||1,pitchDir:Math.sign(n.pitch+n.vPitch*.1)||1};return this.items=this.items.slice(0,e),this.rebuild(),r}pose(){let e=[],t=0,n=0,r=0,i=0,a=0;for(let o of this.items){let s=kd[o.key].h;i+=o.roll,a+=o.pitch;let c=Math.sin(i)*Math.cos(a),l=Math.cos(i)*Math.cos(a),u=Math.sin(a);e.push({uid:o.uid,key:o.key,x:t+c*s/2,y:n+l*s/2,f:r+u*s/2,roll:i,pitch:a}),t+=c*s,n+=l*s,r+=u*s}return e}rebuild(){let e=this.items.length,t=this.items.map(e=>kd[e.key]);this.joints=[];let n=!1,r=t.reduce((e,t)=>e+t.h,0);for(let i=0;i<e;i++){let e=t[i],a=i===0?null:t[i-1],o=a?Math.min(a.w,e.w)*a.grip:1,s=Math.atan(o/e.h)*Ru;this.joints.push({lever:Math.max(.3,r/2),breakAngle:s,whip:1+Lu*i,cushioned:n}),r-=e.h,n||=!!e.cushion}}},_p=.55,vp=.7,yp=2.2,bp=2.6,xp=class{track;phase=`ready`;time=0;s=0;v=12.6;x=0;vx=0;y=0;vy=0;airborne=!1;aLat=0;aLong=0;curvePush=0;towerLat=0;patCooldown=0;stack;banked=[];streak=0;lostItems=[];eggsSmashed=0;tallest=0;tallestMeters=0;events=[];result=null;endedAt=0;lastPat=-9;rand;onRamp=null;airHeight=0;obIndex=0;puIndex=0;stopIndex=0;loopWarned=!1;landedAt=-9;constructor(e){this.track=e,this.rand=Rf(e.seed*7919+1),this.stack=new gp(this.rand)}start(){this.phase===`ready`&&(this.phase=`run`,this.say(`start`))}get value(){return this.stack.items.reduce((e,t)=>e+kd[t.key].pts,0)}get heightBonus(){return 1+Vu*this.stack.items.length}get streakBonus(){return 1+Hu*Math.min(this.streak,4)}get cashBonus(){return this.heightBonus*this.streakBonus}get roadHalf(){return Lf(this.track,this.s)}get bankedTotal(){return this.banked.reduce((e,t)=>e+t.amount,0)}get topSpeed(){let e=6*Math.min(1,this.s/this.track.finishS);return Math.min(38,21+e+Du*this.stack.items.length)}step(e,t){if(this.phase===`ready`)return;if(this.time+=e,this.phase!==`run`){this.v=Math.max(0,this.v-25*e),this.s+=this.v*e,this.stack.step(e,0,0);return}this.patCooldown=Math.max(0,this.patCooldown-e),t.pat&&this.patCooldown===0&&this.stack.items.length&&(this.stack.pat(),this.patCooldown=5,this.lastPat=this.time,this.events.push({type:`pat`})),this.moveForward(e),this.steer(e,t),this.moveVertical(e),this.checkLoopGrip();let n=.6+.6*this.v/38;this.towerLat+=(this.aLat-this.towerLat)*(1-Math.exp(-e/Fu));let r=this.stack.step(e,this.towerLat*n,this.aLong);r&&this.drop(r),this.collide(),this.moveCars(e),this.collect(),this.passStops();let i=this.stack.items.length;i>this.tallest&&(this.tallest=i,this.tallestMeters=this.stack.height),this.s>this.track.finishS&&!this.airborne&&this.v<1&&this.finish()}moveForward(e){let t=this.v,n=this.track.path.at(this.s),r=this.s>this.track.finishS&&!this.airborne,i=n.inLoop?Au:n.pitch<0?Ou:ku,a=-Nu*Math.sin(n.pitch)*i;if(r)this.v=Math.max(0,this.v-16*e);else if(!this.airborne){let t=n.inLoop?Math.max(0,6*(1-this.v/this.topSpeed)):6*(1-this.v/this.topSpeed);this.v+=(t+a)*e,this.v=Math.max(4.2,this.v)}this.aLong=(this.v-t)/e-(n.inLoop?a:0),this.s+=this.v*e,this.curvePush=this.airborne||n.inLoop?0:-(this.v*this.v*n.curve*Math.cos(n.bank)-Nu*Math.sin(n.bank))}steer(e,t){let n=t.targetX??this.x+t.steer*4,r=Lf(this.track,this.s),i=Sp(n,-r,r)-this.x,a=70*ju,o=Math.sign(i)*Math.min(16,Math.sqrt(2*a*Math.abs(i)),Math.abs(i)*8),s=this.airborne?.25:1,c=20/(1+this.stack.mass/400),l=Sp((o-this.vx)*c,-70,70)*s;this.aLat+=Sp(l-this.aLat,-900*e,900*e),this.vx+=this.aLat*e,this.x+=this.vx*e,Math.abs(this.x)>r&&(this.stack.impulse(-Math.sign(this.x)*.25*Math.abs(this.vx)/16,0),Math.abs(this.vx)>3&&this.events.push({type:`curb`}),this.x=Math.sign(this.x)*r,this.vx=0,this.aLat=0)}surface(e){return this.track.path.heightAt(e)+Wf(this.track,e)}moveVertical(e){let t=this.track.path.at(this.s);if(this.airborne){this.airHeight+=this.vy*e,this.vy-=24*e,this.y=this.airHeight-this.surface(this.s),this.y<=0&&this.land(t.pitch);return}let n=Wf(this.track,this.s),r=n>0?this.track.ramps.find(e=>this.s>=e.s&&this.s<=e.s+e.len)??null:null;if(r)this.y=n,this.onRamp=r;else if(this.onRamp){let e=this.onRamp;this.onRamp=null,this.v=Math.max(this.v,35),this.events.push({type:`boost`}),this.launch(this.v*Math.sin(t.pitch+Math.atan(e.h/e.len)),e),(e.finale||this.stack.items.length>3)&&this.say(`bigAir`)}else this.y=0,this.time-this.landedAt>.4&&!t.inLoop&&t.bend<0&&this.v*this.v*-t.bend>9.8*Math.cos(t.pitch)*1.3&&this.launch(this.v*Math.sin(t.pitch),null)}launch(e,t){this.airborne=!0,this.airHeight=this.surface(this.s)+this.y,this.vy=e,this.events.push({type:`launch`,ramp:t})}land(e){let t=Math.max(0,this.v*Math.sin(e)-this.vy);this.airborne=!1,this.landedAt=this.time,this.y=0,this.vy=0,t>3&&(this.v*=.97);let n=this.time-this.lastPat<.6&&this.stack.items.length>0;n&&(this.patCooldown=0);let r=t*Mu*.1,i=this.vx*t*Mu*.012*(n?.25:1);this.stack.impulse(i,r,.35),this.events.push({type:`land`,strength:t,braced:n})}checkLoopGrip(){let e=this.track.path.at(this.s);if(!e.inLoop){this.loopWarned=!1;return}if(this.loopWarned||(this.loopWarned=!0,this.say(`loop`)),this.v*this.v*e.bend+9.8*e.up[1]<3&&this.stack.items.length){let e=this.stack.breakAt(0);e.swept=!0,this.drop(e,!0),this.say(`loopFail`)}}collide(){let e=this.track.obstacles;for(;this.obIndex<e.length&&e[this.obIndex].s<this.s-12;)this.obIndex++;for(let t=this.obIndex;t<e.length&&e[t].s<this.s+12;t++){let n=e[t];if(n.hit)continue;if(n.kind===`overhead`){this.passUnder(n);continue}let r=Math.abs(n.x-this.x)-(n.halfX+_p),i=Math.abs(n.s-this.s)<n.halfS+vp,a=n.kind===`car`||n.kind===`parked`;if(i&&r<0&&this.y<(a?1.3:.4)){if(this.hit(n),this.phase!==`run`)return;continue}a&&n.s-this.s<0&&n.s-this.s>-this.v/60-.01&&r<1&&Math.abs(n.x)<6&&(this.events.push({type:`nearMiss`,obstacle:n}),this.say(`near`))}}passUnder(e){if(Math.abs(e.s-this.s)>e.halfS+.3)return;let t=this.stack.pose(),n=this.y+Bu,r=t.findIndex(t=>n+t.y+kd[t.key].h/2>(e.h??1/0)&&Math.abs(this.x+t.x-e.x)<e.halfX+.3);if(r<0)return;e.hit=!0;let i=this.stack.breakAt(r);i.swept=!0,this.drop(i,!0),this.events.push({type:`hit`,kind:e.kind,obstacle:e,strength:i.items.length}),this.say(`overhead`)}hit(e){let t=this.v/38,n=()=>this.rand()<.5?-1:1;switch(e.hit=!0,e.kind){case`boost`:this.v=Math.max(this.v,48),this.events.push({type:`boost`}),this.say(`boost`);break;case`cans`:this.v*=.88,this.stack.impulse(Math.sign(this.x-e.x||1)*.85*t,.3*t),this.events.push({type:`hit`,kind:e.kind,obstacle:e,strength:t}),this.say(`cans`);break;case`cone`:this.v*=.9,this.stack.impulse(Math.sign(this.x-e.x||1)*.7*t,.3*t),this.events.push({type:`hit`,kind:e.kind,obstacle:e,strength:t});break;case`pothole`:this.v*=.94,this.stack.impulse(n()*.8*t,.5*t),this.events.push({type:`hit`,kind:e.kind,obstacle:e,strength:t}),this.rand()<.4&&this.say(`bump`);break;case`bump`:{let n=t*t;this.stack.impulse(0,1.3*n),this.events.push({type:`hit`,kind:e.kind,obstacle:e,strength:n}),this.say(`bump`);break}case`pigeons`:this.stack.impulse(n()*.08,.1),this.events.push({type:`hit`,kind:e.kind,obstacle:e,strength:t}),this.say(`pigeons`);break;case`car`:case`parked`:case`barricade`:this.wipeout(e)}}wipeout(e){this.phase=`wipeout`,this.endedAt=this.time,this.stack.items.length&&this.drop(this.stack.breakAt(0),!0),this.events.push({type:`wipeout`,obstacle:e}),this.say(`wipeout`),this.v*=.2,this.result=this.makeResult(!0)}moveCars(e){for(let t=this.obIndex;t<this.track.obstacles.length;t++){let n=this.track.obstacles[t];if(n.s>this.s+this.v*2.2+10)break;n.kind===`car`&&n.vx&&(!n.triggered&&n.s-this.s<this.v*2.2&&(n.triggered=!0,this.events.push({type:`honk`,obstacle:n})),n.triggered&&Math.abs(n.x)<12&&(n.x+=n.vx*e))}}collect(){let e=this.track.pickups;for(;this.puIndex<e.length&&e[this.puIndex].s<this.s-3;)this.puIndex++;for(let t=this.puIndex;t<e.length&&e[t].s<this.s+3;t++){let n=e[t];if(!n.taken&&Math.abs(n.s-this.s)<1.1&&Math.abs(n.x-this.x)<1.25&&Math.abs(n.y-this.y)<1.4){n.taken=!0;let e=this.stack.add(n.item,.6+this.v/38*.8);this.events.push({type:`pickup`,pickup:n,uid:e.uid});let t=this.stack.items.length;n.item===`eggs`?this.say(`eggs`):n.item===`turkey`?this.say(`turkey`):t>=12&&t%4==0?this.say(`tall`):t>=5&&this.rand()<.3?this.say(`wobble`):this.rand()<.25&&this.say(`pickup`)}}}passStops(){let e=this.track.stops[this.stopIndex];!e||this.s<e.s||(this.stopIndex++,Math.abs(this.x-e.x)<2.6&&this.stack.items.length?this.cashOut(e):(this.events.push({type:`skip`,stop:e}),this.stack.items.length&&this.say(`skip`),this.streak=0))}cashOut(e){let t=this.stack.items.map(e=>e.key),n=this.stack.items.map(e=>e.uid),r=this.value,i=Math.round(this.cashBonus*10)/10,a={name:e?.name??`Grandma's House`,items:t,value:r,bonus:i,amount:Math.round(r*i)};this.banked.push(a),this.stack.breakAt(0),this.events.push({type:`cashout`,stop:e,banked:a,uids:n}),e&&(this.streak++,this.say(`cashout`))}drop(e,t=!1){for(let t of e.items)this.lostItems.push(t.key),t.key===`eggs`&&this.eggsSmashed++;this.events.push({type:`lost`,lost:e}),t||this.say(e.items.some(e=>e.key===`eggs`)?`lostEggs`:`lost`)}finish(){this.phase=`finished`,this.endedAt=this.time,this.stack.items.length&&this.cashOut(null),this.result=this.makeResult(!1),this.events.push({type:`finish`}),this.say(this.lostItems.length===0?`perfect`:`finish`)}makeResult(e){return{wipeout:e,banked:[...this.banked],score:this.bankedTotal,tallest:this.tallest,tallestMeters:Math.round(this.tallestMeters*10)/10,lost:[...this.lostItems],eggsSmashed:this.eggsSmashed}}say(e){this.events.push({type:`say`,what:e})}};function Sp(e,t,n){return Math.max(t,Math.min(n,e))}var Cp={greedy:{maxStack:99,careful:!1,cashAt:99},greedyCareful:{maxStack:99,careful:!0,cashAt:99},balanced:{maxStack:16,careful:!0,cashAt:10},balancedSmooth:{maxStack:16,careful:!0,smooth:6,cashAt:10},cautious:{maxStack:8,careful:!0,cashAt:4},human:{maxStack:20,careful:!0,smooth:9,cashAt:12,lag:.22,slop:.35,missesPat:.3},rookie:{maxStack:99,careful:!0,cashAt:16,lag:.38,slop:.8,missesPat:.6}},wp=class{style;target=0;steerTo=0;queue=[];aim=0;rand=Rf(7);constructor(e=Cp.balanced){this.style=e}input(e){let{track:t,s:n,v:r}=e,i=e.stack.danger(),a=e.stack.items.length<this.style.maxStack&&i<.5,o=this.target,s=-1/0,c=e.roadHalf-.4;for(let i=-c;i<=c+.001;i+=.2){let c=-Math.abs(i-e.x)*1.5-Math.abs(i-this.target)*1.5;for(let a of t.obstacles){let t=a.s-n;if(t<-1)continue;if(t>38)break;if(a.hit)continue;let o=Math.max(0,t-a.halfS-.7)/Math.max(r,1),s=a.x;if(a.kind===`car`&&a.vx){let e=a.triggered?0:Math.max(0,t/Math.max(r,1)-yp);s=a.x+a.vx*Math.max(0,o-e),Math.sign(a.vx)*(i-s)>-(a.halfX+1)&&t<60&&(c-=1500*(1.2-t/60));continue}let l={car:2e3,parked:2e3,barricade:2e3,cone:70,cans:70,pothole:45,pigeons:8,bump:0,boost:0,overhead:e.y+.55+e.stack.height>(a.h??1/0)-.2?300:0}[a.kind];Math.abs(i-s)<a.halfX+1.1&&(c-=l*(1.2-t/40))}for(let e of t.pickups){let t=e.s-n;if(!(t<1)){if(t>32)break;e.taken||(a&&Math.abs(i-e.x)<.9&&(c+=35*(1.1-t/35)),!a&&Math.abs(i-e.x)<1.4&&(c-=30*(1.1-t/35)))}}let l=t.stops.find(e=>e.s>n&&e.s-n<70);if(l&&e.stack.items.length){let t=Math.abs(i-l.x)<bp-.6;e.stack.items.length>=this.style.cashAt!==t&&(c-=400)}c>s&&(s=c,o=i)}this.target=o;let l=this.style.smooth;if(l&&!(s<-30)){let e=l/60;this.steerTo+=Math.max(-e,Math.min(e,o-this.steerTo))}else this.steerTo=o;let u=!1;if(this.style.careful){let t=e.airborne&&e.vy<0&&e.y<1.8;u=e.patCooldown===0&&(t||!e.airborne&&i>.4)}this.style.missesPat&&u&&this.rand()<this.style.missesPat&&(u=!1);let d=this.steerTo;if(this.style.slop&&(this.aim+=((this.rand()-.5)*this.style.slop-this.aim)*.02,d=Math.max(-c,Math.min(c,this.steerTo+this.aim))),this.style.lag){this.queue.push({at:e.time,target:d,pat:u});let t=this.queue[0];for(;this.queue.length>1&&e.time-this.queue[0].at>=this.style.lag;)t=this.queue.shift();return{targetX:t.target,steer:0,pat:t.pat}}return{targetX:d,steer:0,pat:u}}},Tp={start:[`I only need milk.`,`Gerald, hold my purse.`,`Back in my day we walked. Downhill. Both ways.`],pickup:[`Ooh, on sale!`,`Into the cart!`,`Coupon!`,`Don't mind if I do.`],eggs:[`Careful with the eggs!`,`Eggs. Don't you DARE.`,`Free range. Doomed.`],turkey:[`Thanksgiving is saved!`,`That's a 20-pounder, dear.`,`Frozen solid. Like my hip.`],wobble:[`It's fine. It's FINE.`,`Hold still, you!`,`Ooh, that's tall.`,`Gerald, it's leaning!`],lost:[`MY GROCERIES!`,`That was the good cereal!`,`Eh. Forget it.`,`Somebody catch that!`],lostEggs:[`NOT THE EGGS!`,`Omelette. On the road.`,`Scrambled. Great.`],near:[`Watch it, sonny!`,`I have the right of way!`,`Beep beep, dear!`],bump:[`My hip!`,`Oof!`,`Who put that there?!`],pigeons:[`SHOO!`,`Not today, birds!`,`Get your own cart!`],car:[`Hey!`,`LOOK OUT!`],bigAir:[`WHEEEE!`,`Hold onto your dentures!`,`I'm too old for this! AGAIN!`],finish:[`Home! Where's my tea?`,`Not bad for 87.`,`Same time next week.`],perfect:[`Every. Single. Egg.`,`Gerald, I'm a legend.`],wipeout:[`…we're getting takeout.`,`I'm okay! The cart isn't.`,`Put that in the group chat.`],tall:[`HIGHER, GERALD!`,`I can see my house from here!`,`Is this even legal?`,`Air traffic control, this is Grandma.`],overhead:[`Who hangs signs that low?!`,`Mind your heads, groceries!`,`That sign owes me a turkey.`],cans:[`Clean-up on aisle me!`,`Sorry, young man!`,`They'll bill Gerald.`],cashout:[`Cha-ching!`,`Hold these, dear!`,`Special delivery!`,`Tip your grandma!`],skip:[`Not yet! MORE!`,`Keep stacking!`,`I'm on a roll!`],loop:[`WHEEEEEE!`,`Hold onto your groceries!`,`I did this in 1962!`],loopFail:[`IT'S RAINING TURKEYS!`,`Too slow, Gerald!`,`My groceries!`],boost:[`ZOOM!`,`Faster!`,`Now we're cooking!`]},Ep={hill:`I only need milk.`,market:`Ooh, everything is on sale!`,lanterns:`Ooh, pretty lights!`,roadwork:`Who dug up my hill?!`,boardwalk:`Almost home! Smell that sea air!`},Dp=[`lost`,`lostEggs`,`wipeout`,`finish`,`perfect`,`bigAir`];function Op(e){let t=Tp[e];return t[Math.floor(Math.random()*t.length)]}var kp=e=>{let t=document.createElement(`template`);return t.innerHTML=e.trim(),t.content.firstElementChild},Ap=class{root;stage;sim;hideControls;bubbleText=``;bubbleUntil=0;toasts=[];hookText=``;el={};steerPointer=null;steerStartX=0;steerStartCart=0;targetX=null;keys=new Set;patQueued=!1;bubbleSaid=0;zoneKey=``;landingCheck=null;clock=0;onStart=()=>{};onRestart=()=>{};constructor(e,t,n,r=!1){this.root=e,this.stage=t,this.sim=n,this.hideControls=r,e.innerHTML=``;let i=(t,n)=>this.el[t]=e.appendChild(kp(n));i(`hud`,`<div class="hud outline"><div class="value">$0<small>banked</small></div><div class="tower">0<small>items</small></div></div>`),i(`stop`,`<div class="stop outline"></div>`),i(`wobble`,`<div class="wobble outline">WOBBLE<div class="bar"><i></i></div></div>`),i(`bubble`,`<div class="bubble"><div class="face">👵</div><div class="text"></div></div>`),i(`feed`,`<div class="feed outline"></div>`),i(`toasts`,`<div class="toasts outline"></div>`),i(`zone`,`<div class="zone outline"></div>`),i(`hook`,`<div class="hook outline"></div>`),i(`hint`,`<div class="hint outline">drag anywhere to steer</div>`),i(`controls`,`<div class="controls">
      <button class="btn pat"><div class="cool"></div><span>✋</span>PAT</button></div>`),i(`start`,`<div class="overlay"></div>`),i(`result`,`<div class="overlay hidden"></div>`),r&&(this.el.controls.style.display=`none`,this.el.hint.style.display=`none`),this.bindInput()}bindInput(){this.el.controls.querySelector(`.pat`).addEventListener(`pointerdown`,e=>{e.stopPropagation(),this.patQueued=!0}),this.stage.addEventListener(`pointerdown`,e=>{this.steerPointer===null&&(this.steerPointer=e.pointerId,this.steerStartX=e.clientX,this.steerStartCart=this.sim().x,this.targetX=this.steerStartCart)}),this.stage.addEventListener(`pointermove`,e=>{if(e.pointerId!==this.steerPointer)return;let t=2*this.sim().roadHalf/(this.stage.clientWidth*.55);this.targetX=this.steerStartCart+(e.clientX-this.steerStartX)*t;let n=this.sim().roadHalf;Math.abs(this.targetX)>n&&(this.targetX=Math.sign(this.targetX)*n,this.steerStartCart=this.targetX,this.steerStartX=e.clientX)});let e=e=>{e.pointerId===this.steerPointer&&(this.steerPointer=null)};this.stage.addEventListener(`pointerup`,e),this.stage.addEventListener(`pointercancel`,e),window.addEventListener(`keydown`,e=>{this.keys.add(e.code),(e.code===`Space`||e.code===`ArrowUp`||e.code===`KeyW`)&&(this.patQueued=!0),e.code===`Enter`&&(this.el.start.classList.contains(`hidden`)?this.el.result.classList.contains(`hidden`)||this.onRestart(!1):this.onStart())}),window.addEventListener(`keyup`,e=>this.keys.delete(e.code)),window.addEventListener(`blur`,()=>this.keys.clear())}input(){let e=this.keys,t=(e.has(`ArrowRight`)||e.has(`KeyD`)?1:0)-(e.has(`ArrowLeft`)||e.has(`KeyA`)?1:0),n=this.patQueued;return this.patQueued=!1,t&&(this.targetX=null),{targetX:t?null:this.targetX,steer:t,pat:n}}handle(e){let t=this.sim();switch(e.type){case`say`:this.say(Op(e.what),Dp.includes(e.what));break;case`pickup`:{let t=kd[e.pickup.item];this.feed(`+${t.emoji} $${t.pts}`,``);break}case`lost`:{let t=e.lost.items.length,n=e.lost.items.slice(0,6).map(e=>kd[e.key].emoji).join(``);this.feed(`−${n}${t>6?`…`:``}`,`bad`),t>=4&&this.toast(`−${t} ITEMS!`,`bad`);break}case`nearMiss`:this.toast(`NEAR MISS! ×+0.3`,`big`);break;case`land`:e.braced&&this.toast(`BRACED!`,``),e.strength>9&&t.stack.items.length&&(this.landingCheck={at:this.clock,items:t.stack.items.length,braced:e.braced});break;case`honk`:this.say(Op(`car`),!0);break;case`cashout`:e.stop&&this.toast(`💰 +$${e.banked.amount.toLocaleString()}`,`cash`);break;case`skip`:t.stack.items.length&&this.toast(`KEEP STACKING!`,`big`)}}update(e,t){this.clock+=t;let n=this.el.hud,r=e.stack.items.length;n.querySelector(`.value`).innerHTML=`$${e.bankedTotal.toLocaleString()}<small>banked</small>`,n.querySelector(`.tower`).innerHTML=r?`${r} 🛒<small>worth $${Math.round(e.value*e.cashBonus).toLocaleString()} (×${e.cashBonus.toFixed(1)})</small>`:`0 🛒<small>empty cart</small>`;let i=e.track.stops.find(t=>t.s>e.s-2),a=i?i.s-e.s:1/0,o=this.el.stop;if(i&&a<140&&r>0&&e.phase===`run`){let t=i.x<0?`⬅`:`➡`,n=e.streak>0?` · 🔥 ${e.streak+1} in a row`:``;o.innerHTML=`${i.x<0?t+` `:``}💰 CASH OUT $${Math.round(e.value*e.cashBonus).toLocaleString()}${i.x>0?` `+t:``}<small>${i.name} · ${Math.max(0,Math.round(a))}m${n}</small>`,o.classList.add(`show`),o.classList.toggle(`left`,i.x<0)}else o.classList.remove(`show`);let s=e.phase===`run`?e.stack.danger():0;this.el.wobble.classList.toggle(`show`,r>0&&e.phase===`run`),this.el.wobble.classList.toggle(`danger`,s>.65),this.el.wobble.querySelector(`.bar i`).style.width=`${Math.min(100,s*100)}%`;let c=this.el.controls.querySelector(`.pat`);c.querySelector(`.cool`).style.transform=`scaleY(${e.patCooldown/5})`,c.classList.toggle(`ready`,e.patCooldown===0&&s>.4),this.landingCheck&&this.clock-this.landingCheck.at>.7&&(e.stack.items.length>=this.landingCheck.items&&this.toast(`STUCK THE LANDING!`,`big`),this.landingCheck=null);let l=Td(e.s);l.key!==this.zoneKey&&e.phase===`run`&&(this.zoneKey&&this.announce(l.title),this.zoneKey=l.key,e.time>1&&this.say(Ep[l.key],!0)),this.el.bubble.classList.toggle(`show`,this.clock<this.bubbleUntil),e.time>4&&(this.el.hint.style.opacity=`0`),this.toasts=this.toasts.filter(e=>this.clock-e.born<(e.cls===`zone`?2.2:1.4))}say(e,t=!1){!t&&this.clock-this.bubbleSaid<1.6||(this.bubbleSaid=this.clock,this.bubbleText=e,this.bubbleUntil=this.clock+2.3,this.el.bubble.querySelector(`.text`).textContent=e,this.el.bubble.classList.remove(`show`),this.el.bubble.offsetWidth,this.el.bubble.classList.add(`show`))}feed(e,t){let n=kp(`<div class="${t}"></div>`);for(n.textContent=e,this.el.feed.prepend(n);this.el.feed.children.length>4;)this.el.feed.lastElementChild.remove();setTimeout(()=>n.remove(),1400),this.toasts.push({text:e,cls:`feed ${t}`,born:this.clock})}announce(e){let t=this.el.zone;t.textContent=e,t.classList.remove(`show`),t.offsetWidth,t.classList.add(`show`),this.toasts.push({text:e,cls:`zone`,born:this.clock})}toast(e,t){let n=kp(`<div class="toast ${t}"></div>`);n.textContent=e,n.style.top=`${this.el.toasts.children.length*38}px`,this.el.toasts.appendChild(n),setTimeout(()=>n.remove(),1100),this.toasts.push({text:e,cls:t,born:this.clock})}showHook(e,t=3){this.hookText=e,this.el.hook.textContent=e,this.el.hook.classList.add(`show`),setTimeout(()=>{this.el.hook.classList.remove(`show`),this.hookText=``},t*1e3)}showStart(e,t=`TAP TO START`){let n=this.el.start;n.classList.remove(`hidden`),n.innerHTML=`
      <div class="logo outline">GRANDMA'S<small>SHOPPING CART</small></div>
      <div class="tag outline">She only needed milk.</div>
      ${this.hideControls?``:`<div class="how">👆 Drag to steer · smooth = steady<br>🛒 Taller tower = faster + bigger bonus<br>💰 Drive under a gold sign to cash out<br>✋ Tap to steady · tap as you land to brace</div>`}
      <button class="go">${t}</button>
      ${e?`<div class="outline" style="margin-top:14px;font-size:15px">Best: $${e.toLocaleString()}</div>`:``}`;let r=n.querySelector(`.go`);r.addEventListener(`pointerdown`,e=>e.stopPropagation()),r.addEventListener(`click`,()=>this.onStart())}hideStart(){this.el.start.classList.add(`hidden`)}showResult(e,t,n){let r=this.el.result,i=e.wipeout?`WIPEOUT!`:e.score>0?`HOME SAFE!`:`EMPTY-HANDED…`,a=e.wipeout?Op(`wipeout`):Op(`finish`),o=e.banked.length?e.banked.map(e=>`<div class="bank"><span>${e.name}<small>${e.items.length} items · $${e.value} × ${e.bonus.toFixed(1)}</small></span><b>$${e.amount.toLocaleString()}</b></div>`).join(``):`<div class="bank"><span>Nothing banked<small>Cash out under the gold arches!</small></span><b>$0</b></div>`;r.classList.remove(`hidden`),r.innerHTML=`
      <div class="card">
        <h1>${i}</h1>
        <div class="quote">👵 “${a}”</div>
        <div class="tallest">🏆 Tallest tower: <b>${e.tallest} items · ${e.tallestMeters}m</b></div>
        ${o}
        <div class="score">$${e.score.toLocaleString()}</div>
        ${e.score>=t&&e.score>0?`<div class="best">★ NEW BEST</div>`:t?`<div class="best">Best: $${t.toLocaleString()}</div>`:``}
        ${n?`<div class="score" style="font-size:24px;color:var(--red)">${n}</div>`:`<div class="buttons"><button class="go again">GO AGAIN</button><button class="go alt new">NEW HILL</button></div>`}
      </div>`,r.querySelectorAll(`button`).forEach(e=>e.addEventListener(`pointerdown`,e=>e.stopPropagation())),r.querySelector(`.again`)?.addEventListener(`click`,()=>this.onRestart(!1)),r.querySelector(`.new`)?.addEventListener(`click`,()=>this.onRestart(!0))}hideResult(){this.el.result.classList.add(`hidden`)}},jp=new URLSearchParams(location.search),Mp=document.getElementById(`game`),Np=document.getElementById(`stage`);function Pp(){try{return Number(localStorage.getItem(`gc.best`)??0)}catch{return 0}}function Fp(e){try{localStorage.setItem(`gc.best`,String(e))}catch{}}var Ip=Number(jp.get(`seed`)??1),Lp=new xp(Uf(Ip)),Rp=new Cu({canvas:Mp,antialias:!0});Rp.setPixelRatio(Math.min(window.devicePixelRatio,2)),Rp.shadowMap.enabled=!0,Rp.shadowMap.type=1;var zp=new pp(Rp,Lp),Bp=od.on||jp.has(`bot`),Vp=new wp(Cp[od.style]??Cp.balanced),Hp=new Ap(document.getElementById(`ui`),Np,()=>Lp,Bp),Up=od.record?new dd:null,Wp=0,Gp=1,Kp=0,qp=0,Jp=!1;function Yp(){zp.resize(Np.clientWidth,Np.clientHeight)}window.addEventListener(`resize`,Yp),Yp(),Hp.onStart=()=>{Xu(),Hp.hideStart(),Up&&Up.start(),od.hook&&Hp.showHook(od.hook),Lp.start()},Hp.onRestart=e=>{e&&(Ip=Math.floor(Math.random()*1e6)),zp.dispose(),Lp=new xp(Uf(Ip)),zp=new pp(Rp,Lp),Vp=new wp(Cp[od.style]??Cp.balanced),Yp(),Hp.hideResult(),Jp=!1,Wp=0,Hp.onStart()},Hp.showStart(Pp(),Up?`● RECORD`:od.on?`START`:`TAP TO START`);function Xp(e){qp+=e,qp>Kp&&(Gp=Math.min(1,Gp+e*2));let t=e*Gp;Wp+=t;let n=0;for(;Wp>=.016666666666666666&&n<8;){Lp.step(wu,Bp&&Lp.phase===`run`?Vp.input(Lp):Hp.input());for(let e of Lp.events)zp.handle(e),Hp.handle(e),id(e,Lp),e.type===`launch`&&e.ramp?.finale&&Zp(.55,.8),e.type===`wipeout`&&Zp(.25,1.2);Lp.events.length=0,Wp-=wu,n++}if(n===8&&(Wp=0),zp.update(t),Hp.update(Lp,e),rd(Lp,e),zp.render(),Up?.draw(Mp,Lp,Hp,Hp.clock),Lp.result&&!Jp&&Lp.time-Lp.endedAt>(Lp.result.wipeout?1.6:1.4)){Jp=!0;let e=Pp();Lp.result.score>e&&!Bp&&Fp(Lp.result.score),Hp.showResult(Lp.result,Math.max(e,Lp.result.score),od.on&&od.cta||void 0),Up&&(Up.result=Lp.result,setTimeout(()=>Up.stop(`grandma-cart-${Ip}-${Date.now()}`),3500))}}function Zp(e,t){Gp=e,Kp=qp+t}var Qp=performance.now();function $p(e){let t=Math.min(.1,(e-Qp)/1e3);Qp=e,Xp(t),requestAnimationFrame($p)}requestAnimationFrame($p),window.gc={get sim(){return Lp},start:()=>Hp.onStart(),advance:e=>{for(let t=0;t<e;t+=1e3/60)Xp(1/60);return{phase:Lp.phase,s:Math.round(Lp.s),stack:Lp.stack.items.length,lost:Lp.lostItems.length}}};